function server(){
  SRV=eval(document.getElementById("server").value),
  calc()
}
function restrictEquipslot(){
  ...
  (3==w||5==w||7==w||10==w||11==w||16==w||17==w||18==w||19==w||20==w||21==w||n_Nitou)&&
  equip_restrict?
    (c.A_LEFT_DEF_PLUS.disabled=!0,c.A_left.disabled=!0,c.A_LEFT_DEF_PLUS.value=0,c.A_left.value=305,c.A_left_card.disabled=!0,c.A_left_card.value=0):
    (c.A_LEFT_DEF_PLUS.disabled=!1,c.A_left.disabled=!1,card_restrict&&0!=ItemOBJ[c.A_left.value][5]&&(c.A_left_card.disabled=!1))
}
function restrictCardslot(select_ID){
  var c=document.calcForm;
  card_restrict=eval(document.getElementById("restrict_cardslot").checked),
  card_restrict?(
    0!=ItemOBJ[c.A_weapon1.value][5]?
      (c.A_weapon1_card1.disabled=!1,c.A_weapon1_card2.disabled=!1,c.A_weapon1_card3.disabled=!1,c.A_weapon1_card4.disabled=!1):
      (c.A_weapon1_card1.disabled=!0,c.A_weapon1_card1.value=0,c.A_weapon1_card2.disabled=!0,c.A_weapon1_card2.value=0,
       c.A_weapon1_card3.disabled=!0,c.A_weapon1_card3.value=0,c.A_weapon1_card4.disabled=!0,c.A_weapon1_card4.value=0),
    n_Nitou&&(
      0!=ItemOBJ[c.A_weapon2.value][5]?
        (c.A_weapon2_card1.disabled=!1,c.A_weapon2_card2.disabled=!1,c.A_weapon2_card3.disabled=!1,c.A_weapon2_card4.disabled=!1):
        (c.A_weapon2_card1.disabled=!0,c.A_weapon2_card1.value=0,c.A_weapon2_card2.disabled=!0,c.A_weapon2_card2.value=0,
         c.A_weapon2_card3.disabled=!0,c.A_weapon2_card3.value=0,c.A_weapon2_card4.disabled=!0,c.A_weapon2_card4.value=0)
    ),
    0!=ItemOBJ[c.A_head1.value][5]?c.A_head1_card.disabled=!1:(c.A_head1_card.disabled=!0,c.A_head1_card.value=0),
    0!=ItemOBJ[c.A_head2.value][5]?c.A_head2_card.disabled=!1:(c.A_head2_card.disabled=!0,c.A_head2_card.value=0),
    0!=ItemOBJ[c.A_left.value][5]?c.A_left_card.disabled=!1:(c.A_left_card.disabled=!0,c.A_left_card.value=0),
    0!=ItemOBJ[c.A_body.value][5]?c.A_body_card.disabled=!1:(c.A_body_card.disabled=!0,c.A_body_card.value=0),
    0!=ItemOBJ[c.A_shoulder.value][5]?c.A_shoulder_card.disabled=!1:(c.A_shoulder_card.disabled=!0,c.A_shoulder_card.value=0),
    0!=ItemOBJ[c.A_shoes.value][5]?c.A_shoes_card.disabled=!1:(c.A_shoes_card.disabled=!0,c.A_shoes_card.value=0),
    0!=ItemOBJ[c.A_acces1.value][5]?c.A_acces1_card.disabled=!1:(c.A_acces1_card.disabled=!0,c.A_acces1_card.value=0),
    0!=ItemOBJ[c.A_acces2.value][5]?c.A_acces2_card.disabled=!1:(c.A_acces2_card.disabled=!0,c.A_acces2_card.value=0)
  ):(
    c.A_weapon1_card1.disabled=!1,c.A_weapon1_card2.disabled=!1,c.A_weapon1_card3.disabled=!1,c.A_weapon1_card4.disabled=!1,
    n_Nitou&&(c.A_weapon2_card1.disabled=!1,c.A_weapon2_card2.disabled=!1,c.A_weapon2_card3.disabled=!1,c.A_weapon2_card4.disabled=!1),
    c.A_head1_card.disabled=!1,c.A_head2.disabled?c.A_head2_card.disabled=!0:c.A_head2_card.disabled=!1,
    ...
    c.A_acces1_card.disabled=!1,c.A_acces2_card.disabled=!1
  ),
  calc()
}
...
function BattleCalc999(){
  ...
  if(
    str_bSUBname="",
    str_bSUB="",
    n_A_ActiveSkill==0||n_A_ActiveSkill==272||n_A_ActiveSkill==401||n_A_ActiveSkill==86&&50<=n_B[3]&&n_B[3]<60||
      (myInnerHtml("CRIATK","",0),myInnerHtml("CRInum","",0),myInnerHtml("CRIATKname","",0),myInnerHtml("CRInumname","",0)),
    n_A_WeaponType!=10&&n_A_WeaponType!=17&&n_A_WeaponType!=18&&n_A_WeaponType!=19&&n_A_WeaponType!=20&&n_A_WeaponType!=21||n_A_ActiveSkill!=0||
      (n_Enekyori=1),
    n_A_ActiveSkill==0||n_A_ActiveSkill==86&&50<=n_B[3]&&n_B[3]<60
  ){
    if(
      myInnerHtml("CRIATKname",SubName[3],0),
      myInnerHtml("CRInumname",SubName[4],0),
      n_A_ActiveSkill==86&&(n_Delay[0]=1),n_Nitou
    ){
      if(
        ...
        n_A_workDEX>=n_A_Weapon2_ATK?
          ...
          w_left_Maxatk=n_A_ATK+n_A_Weapon2LV_Maxplus+Math.floor((n_A_Weapon2_ATK+wImp-1)*wCSize),
        ...
        w_left_star=0,106==n_A_card[4]&&106==n_A_card[5]&&106==n_A_card[6]
      ) w_left_star+=40;
      else
        for(i=4;6>=i;i++) 106==cardOBJ[n_A_card[i]][0]&&(w_left_star+=5);
      106==n_A_card[7]&&(w_left_star+=10),
      w_left_Maxatk+=w_left_star,w_left_Maxatk=w_left_Maxatk*(3+SkillSearch(80))/10,w_left_Maxatk=Math.floor(w_left_Maxatk),
      ...
      w_left_Minatk+=w_left_star,w_left_Minatk*=.3+SkillSearch(80)/10,w_left_Minatk=Math.floor(w_left_Minatk),
      w_left_Aveatk=(w_left_Maxatk+w_left_Minatk)/2,
      w_left_Maxatk=tPlusDamCut(w_left_Maxatk),w_left_Minatk=tPlusDamCut(w_left_Minatk),w_left_Aveatk=tPlusDamCut(w_left_Aveatk),
      ATKbai02(wbairitu,0),
      n_Min_DMG+=w_left_Minatk,n_Max_DMG+=w_left_Maxatk,
      ...
      SRV?
        wX+w_left_Minatk<n_Min_DMG&&w998G<100&&(n_Min_DMG=wX+w_left_Minatk):
        Last_DMG_A[0]<n_Min_DMG&&(w998H>0?n_Min_DMG=Last_DMG_A[0]:w998D>0&&2*wX+w_left_Minatk<n_Min_DMG&&(n_Min_DMG=2*wX+w_left_Minatk)),
      w_DMG[0]=n_Min_DMG,
      ...
      w998D&&(wX=2*(w_DMG[2]+EDP_DMG(2))+w_left_Maxatk,str_bSUB+=wX+" ("+w998D+"%)<BR>"),
      wX>n_Max_DMG&&w998G<100&&(n_Max_DMG=wX),
      w_DMG[2]=n_Max_DMG,
      ...
      w_DMG[1]=BattleCalc3(w_DMG[1]),w_DMG[1]+=BattleCalc3left(w_left_Aveatk),w_DMG[1]+=EDP_DMG(1),EDPhyouzi(1);
      var wX=BattleCalc2(0),wX2=Math.floor(w_left_star*(.3+SkillSearch(80)/10));
      n_PerHIT_DMG=wX+wX2,str_PerHIT_DMG=wX+"+"+wX2,
      CastAndDelay(),
      BattleCalc998()
    }else{
      ...
      var w_KATARU=[0,0,0], w_Ave_KATARU=0;
      ...
      11==n_A_WeaponType&&(InnStr[0]=Last_DMG_A[0]+" ("+Last_DMG_B[0]+"+"+w_KATARU[0]+")"),
      SRV?
        Last_DMG_A[0]<n_Min_DMG&&w998G<100&&(n_Min_DMG=Last_DMG_A[0]):
        Last_DMG_A[0]<n_Min_DMG&&(w998H>0?n_Min_DMG=Last_DMG_A[0]:w998D>0&&2*Last_DMG_A[0]<n_Min_DMG&&(n_Min_DMG=2*Last_DMG_A[0])),
      w998D&&(17==n_A_WeaponType&&SkillSearch(427)?
        CardNumSearch(43)||570==n_A_Equip[2]||1442==n_A_Equip[2]||1443==n_A_Equip[2]||1321==n_A_Equip[2]||EquipNumSearch(1578)&&n_A_SHOULDER_DEF_PLUS>=5?
      ...
      11==n_A_WeaponType&&(InnStr[2]=Last_DMG_A[2]+" ("+Last_DMG_B[2]+"+"+w_KATARU[2]+")"),
      ...
      if(wX+=n_TAKA_DMG,n_Max_DMG<wX&&w998G<100&&(n_Max_DMG=wX),w998D){
        ...
        wX+=n_TAKA_DMG,
        n_Max_DMG<wX&&(n_Max_DMG=wX)
      }
      w_DMG[2]=n_Max_DMG,
      Last_DMG_B[1]=w_DMG[1]+EDP_DMG(1),
      Last_DMG_A[1]=Last_DMG_B[1]+w_KATARU[1],
      InnStr[1]+=Last_DMG_A[1],
      11==n_A_WeaponType&&(InnStr[1]=Last_DMG_A[1]+" ("+Last_DMG_B[1]+"+"+w_KATARU[1]+")"),
      SkillSearch(187)&&(TyouEnkakuSousa3dan=san[1]),
    ...
    if(272==n_A_ActiveSkill||401==n_A_ActiveSkill){
      for(
        ...
        272==n_A_ActiveSkill?
          (n_Enekyori=1,wbairitu+=1+.5*n_A_ActiveSkillLV,wCast=2*n_A_CAST,n_Delay[2]=1.5):
          (n_Delay[0]=1,n_Enekyori=0,wbairitu+=n_A_ActiveSkillLV-1),
        i=0;2>=i;i++
    ...
    for(w_ActS=[6,7,19,41,44,65,71,72,73,83,84,111,158,161,169,171,176,188,189,199,207,248,260,261,264,288,289,290,292,302,303,305,306,307,308,326,317,318,
      331,333,335,337,339,382,388,398,400,419,423,428,430,431,432,434,435,436,437,"NULL"],iw=0;w_ActS[iw]!=n_A_ActiveSkill&&"NULL"!=w_ActS[iw];iw++);
    if(n_A_ActiveSkill==w_ActS[iw]){
      if(wActiveHitNum=1,6==n_A_ActiveSkill) wbairitu+=.3*n_A_ActiveSkillLV;
        ...
        w=1+.2*n_A_ActiveSkillLV,
        n_A_ActiveSkillLV==10?wbairitu+=4.625:
        n_A_ActiveSkillLV>=7?wbairitu+=w+w/2+w/4-1:
        n_A_ActiveSkillLV>=4?wbairitu+=w+w/2-1:wbairitu+=w-1,
        wCast=.7;
      else if(83==n_A_ActiveSkill||388==n_A_ActiveSkill)
        wActiveHitNum=8,wbairitu+=.5*n_A_ActiveSkillLV+2,
        388==n_A_ActiveSkill&&0==Taijin&&(wbairitu*=2),
        ...
        wCast=1.5,wbairitu+=.4*n_A_ActiveSkillLV-.4,n_A_Weapon_zokusei=ArrowOBJ[n_A_Arrow][1],
        0!=eval(document.calcForm.A_Weapon_zokusei.value)&&(n_A_Weapon_zokusei=eval(document.calcForm.A_Weapon_zokusei.value)),n_Enekyori=1;
        ...
        wActiveHitNum=9,wbairitu+=1+n_A_ActiveSkillLV,n_A_Weapon_zokusei=ArrowOBJ[n_A_Arrow][1],
        0!=eval(document.calcForm.A_Weapon_zokusei.value)&&(n_A_Weapon_zokusei=eval(document.calcForm.A_Weapon_zokusei.value)),n_Enekyori=1,
        wCast=1.8+.2*n_A_ActiveSkillLV,n_A_ActiveSkillLV>=6?n_Delay[2]=1:n_Delay[2]=.8,n_Delay[3]=3;
        ...
        326==n_A_ActiveSkill?(
          ...
          0==CT_WEIGHT?(
            SkillSearch(154)&&(wbairitu+=.146+Math.floor((n_tok[22]+5*SkillSearch(154))/100*100/100)),
            SkillSearch(327)&&(wbairitu+=.215+Math.floor((n_tok[22]+10*SkillSearch(327))/100*100/100))
            ):
            wbairitu+=.02+Math.floor((CT_WEIGHT/(16-n_A_ActiveSkillLV)+n_tok[22]+5*SkillSearch(154)+20*SkillSearch(327))/100*100/100)
          ):
            wbairitu+=Math.floor(eval(document.calcForm.SkillSubNum.value)/(16-n_A_ActiveSkillLV)/100*100)/100
        ):
...
//        305==n_A_ActiveSkill?(n_Delay[0]=1,SkillSearch(379)&&0==n_A_WeaponType?wbairitu+=.08*n_A_BaseLV-1:wbairitu+=.04*n_A_BaseLV-1):
        ...
        400==n_A_ActiveSkill?(n_Delay[0]=1,wbairitu+=.1*n_A_ActiveSkillLV,n_Delay[2]=1):
        419==n_A_ActiveSkill?(not_use_card=1,wCast=.5,n_Delay[2]=1,n_Enekyori=1,wActiveHitNum=5,(2==n_B[2]||7==n_B[2])&&(wbairitu+=4)):
        423==n_A_ActiveSkill?(n_Enekyori=1,n_Delay[2]=.5,n_A_Weapon_zokusei=8,not_use_card=1):
        428==n_A_ActiveSkill?(n_Enekyori=1,wActiveHitNum=5,wbairitu+=.5*n_A_ActiveSkillLV+4,n_Delay[2]=1.7):
        430==n_A_ActiveSkill?(
          SRV?(
            n_A_Weapon_ATKplus>8&&EquipNumSearch(1100)?TCcast=1.25:EquipNumSearch(926)?TCcast=.75:TCcast=1,wCast=(1+.2*n_A_ActiveSkillLV)*TCcast
          ):(
            wCast=1+.2*n_A_ActiveSkillLV,cast_kotei=1
          ),
          n_Enekyori=1,wbairitu+=1*n_A_ActiveSkillLV+1,n_Delay[2]=1,w_HIT=5*w_HIT+5,w_HIT>100&&(w_HIT=100),w_HIT_HYOUJI=w_HIT
        ):
        431==n_A_ActiveSkill?(wCast=2,n_Delay[2]=1,n_Enekyori=1):
        432==n_A_ActiveSkill?(wCast=1.5,n_Enekyori=1,wbairitu+=.2*n_A_ActiveSkillLV,n_Delay[2]=.5,w_HIT=100,w_HIT_HYOUJI=100):
        434==n_A_ActiveSkill?(cast_kotei=1,wCast=1,n_Enekyori=0,wbairitu+=.5*n_A_ActiveSkillLV,n_Delay[3]=1):
        435==n_A_ActiveSkill?(n_Enekyori=1,wbairitu+=1*n_A_ActiveSkillLV+2,n_Delay[2]=1+.2*n_A_ActiveSkillLV):
        436==n_A_ActiveSkill?(n_Enekyori=1,wbairitu+=.2*n_A_ActiveSkillLV-.2,wCast=1,n_Delay[2]=1):
      ...
      w_MagiclBulet=1,w_DMG[1]=(w_DMG[1]*w_HIT+BattleCalc2(0)*(100-w_HIT))/100,EDPplus(1),
      ...
      for(var i=0;2>=i;i++)
        SRV?
          (w_DMG[i]=BattleCalc(BK_n_A_MATK[i]*(1+.05*n_A_Buf2[8]),i)-1,0==n_A_WeaponType&&(w_DMG[1]=w_DMG[0],w_DMG[2]=w_DMG[0])):
          w_DMG[i]=BattleCalc(BK_n_A_MATK[i],i),
        Last_DMG_A[i]=Last_DMG_B[i]=w_DMG[i]+EDP_DMG(i),
        InnStr[i]+=Last_DMG_A[i];
      n_PerHIT_DMG=BattleCalc2(0)+n_A_WeaponLV_seirenATK,w_DMG[1]=(w_DMG[1]*w_HIT+n_PerHIT_DMG*(100-w_HIT))/100,
      EDPplus(1),CastAndDelay(),BattleCalc998()
    }else if(40==n_A_ActiveSkill||70==n_A_ActiveSkill||111==n_A_ActiveSkill||192==n_A_ActiveSkill||
      76==n_A_ActiveSkill||418==n_A_ActiveSkill||391==n_A_ActiveSkill||429==n_A_ActiveSkill
    ){
      if(40==n_A_ActiveSkill) n_Enekyori=1,wbairitu+=.1*n_A_ActiveSkillLV-.1,wHITsuu=2;
        ...
        wbairitu+=.4*n_A_ActiveSkillLV,wCast=.7*n_A_CAST,wHITsuu=2,
        1==n_A_ActiveSkillLV&&(wHITsuu=1),wLAch=1,1==n_B_IJYOU[6]&&(wHITsuu=3,1==n_A_ActiveSkillLV&&(wHITsuu=2));
      else if(192==n_A_ActiveSkill)
        wbairitu+=.5*n_A_ActiveSkillLV,w=n_A_Buf2[12],w>n_A_ActiveSkillLV&&(w=n_A_ActiveSkillLV),wHITsuu=w,wCast=(1+w)*n_A_CAST,n_Delay[2]=.5,n_Enekyori=1;
      ...
      EDPplus(wHITsuu),n_PerHIT_DMG=wX*wHITsuu,str_PerHIT_DMG=wX*wHITsuu+" ("+wHITsuu+SubName[8]+wX+" Damage)",
      ...
      271==n_A_ActiveSkill?(
        ...
        wCast=1.5*n_A_CAST,n_Delay[2]=1
      );
      for(var i=0;2>=i;i++)
        Last_DMG_A[i]=Last_DMG_B[i]=wBT,
        InnStr[i]+=Last_DMG_A[i],
        118==n_A_ActiveSkill&&(Last_DMG_B[i]=wBT/n_A_ActiveSkillLV,InnStr[i]+=" ("+Last_DMG_B[i]+" x "+n_A_ActiveSkillLV+"Hit)"),
        w_DMG[i]=wBT;
      w_HIT_HYOUJI=100,
      CastAndDelay(),BattleCalc998()
      ...
      n_PerHIT_DMG=wINV;
      for(var i=0;2>=i;i++)
        w_DMG[i]=BattleCalc(n_A_DMG[i],i),w_DMG[i]=Math.floor(w_DMG[i]*zokusei[n_B[3]][5]),
        Last_DMG_A[i]=Last_DMG_B[i]=w_DMG[i]+EDP_DMG(i),
        InnStr[i]+=Last_DMG_A[i];
      ...
      if(SRV){
        ...
        var n_A_ATK_WC=20*CardNumSearch(11)+5*CardNumSearch(28)+5*CardNumSearch(29)+5*CardNumSearch(30)+5*CardNumSearch(33)+5*CardNumSearch(34)+
          5*CardNumSearch(35)+5*CardNumSearch(36)+5*CardNumSearch(37)+10*CardNumSearch(38)+5*CardNumSearch(39)+5*CardNumSearch(110)+5*CardNumSearch(163)+
          5*CardNumSearch(165)+5*CardNumSearch(254)+5*CardNumSearch(259)+5*CardNumSearch(326)+5*CardNumSearch(356)+5*CardNumSearch(366)+5*CardNumSearch(380)+
          5*CardNumSearch(463)+5*CardNumSearch(498)+5*CardNumSearch(525), SC_ATK=n_A_ATK-n_A_ATK_WC;
        SkillSearch(12)&&(SC_ATK+=.32*SC_ATK),
        n_A_Buf6[5]&&(SC_ATK+=Math.floor((.02+.03*n_A_Buf6[5])*SC_ATK)),
        n_A_Buf6[5]&&n_A_Buf7[31]?SC_ATK+=0:n_A_Buf7[31]&&(SC_ATK+=Math.floor(.05*SC_ATK));
        for(var i=0;2>=i;i++)
          w_DMG[i]=SC_ATK*wbairitu+ItemOBJ[n_A_Equip[5]][6],
          w_DMG[i]=Math.floor(Math.floor(5*w_DMG[i]*(100-n_B[14])/100-n_B_DEF2[i])*wbairitu2)+5*n_A_LEFT_DEF_PLUS*2,
          w_DMG[i]=BaiCI(w_DMG[i]),
          w_DMG[i]<1&&(w_DMG[i]=1),
          305==ItemOBJ[n_A_Equip[5]][0]?
            (w_DMG[i]=0,InnStr[i]+=w_DMG[i]+" (no shield equiped)"):
            (w_DMG[i]=Math.floor(w_DMG[i]*zokusei[n_B[3]][0]),
              Last_DMG_B[i]=Math.floor(w_DMG[i]/5)+Math.floor(n_B_DEF2[i]/3-1),Last_DMG_A[i]=5*Last_DMG_B[i],
              InnStr[i]+=Last_DMG_A[i]+" ("+Last_DMG_B[i]+SubName[8]+"5hit)",
              w_DMG[i]=Last_DMG_A[i]);
        w_DMG[1]=w_DMG[1]*w_HIT/100
      }else{
        n_PerHIT_DMG=0,n_Enekyori=1,n_A_Weapon_zokusei=0,wCast=1*n_A_CAST,n_Delay[2]=1,wSBr=n_A_LEFT_DEF_PLUS,
        wSC=ItemOBJ[n_A_Equip[5]][6],wbairitu2=1+.3*n_A_ActiveSkillLV,
        n_A_ATK_w=Math.round(Math.floor(n_A_STR/10)*Math.floor(n_A_STR/10)),
        n_A_ATK=n_A_STR+n_A_ATK_w+Math.floor(n_A_DEX/5)+Math.floor(n_A_LUK/5),
        n_A_ATK=n_A_ATK*wbairitu+wSC+4*wSBr,
        wSC-=100,wSC<0&&(wSC=0),
        wSC2=[0,0,0],
        wSC2[2]=100+wSC+2*wSBr*wSBr,
        wSC2[1]=100+(wSC+2*wSBr*wSBr)/2,
        wSC2[0]=100;
        for(var i=0;2>=i;i++)
          ...
          305==ItemOBJ[n_A_Equip[5]][0]&&(w_DMG[i]=0),
          w_DMG[i]=Math.floor(w_DMG[i]*zokusei[n_B[3]][0]),
          Last_DMG_A[i]=5*w_DMG[i],Last_DMG_B[i]=w_DMG[i],
          InnStr[i]+=Last_DMG_A[i]+" ("+Last_DMG_B[i]+SubName[8]+"5hit)",
          w_DMG[i]=Last_DMG_A[i];
        w_DMG[1]=w_DMG[1]*w_HIT/100
      }
      ...
      n_Enekyori=1,
      SRV?wSPP2=n_A_Weapon_ATKplus*zokusei[n_B[3]][n_A_Weapon_zokusei]:wSPP2=n_A_WeaponLV_seirenATK*zokusei[n_B[3]][n_A_Weapon_zokusei],
      wSPP2=BaiCI(wSPP2),wSPP2=tPlusDamCut(wSPP2),n_PerHIT_DMG=5*wSPP2,
      ...
      w_DMG[2]=wSPP*wSPP+.8*ItemOBJ[n_A_Equip[0]][6]*(1+.5* n_A_ActiveSkillLV),
      wSPP=1.25-.25*n_B[4],
      SRV?w_DMG[2]=Math.floor(w_DMG[2]*wSPP)+10+1.5*n_A_Weapon_ATKplus:w_DMG[2]=Math.floor(w_DMG[2]*wSPP+n_A_WeaponLV_seirenATK),
      w_DMG[2]=w_DMG[2]*zokusei[n_B[3]][n_A_Weapon_zokusei],
      w_DMG[2]=BaiCI(w_DMG[2]),
      w_DMG[0]=w_DMG[1]=w_DMG[2];
      for(var i=0;2>=i;i++)
        Last_DMG_B[i]=w_DMG[i]+EDP_DMG(i),Last_DMG_A[i]=5*Last_DMG_B[i],
        InnStr[i]+=Last_DMG_A[i]+" ("+Last_DMG_B[i]+SubName[8]+"5hit)",
        w_DMG[i]=Last_DMG_A[i];
      ...
      w_SBr=new Array,
      w=5*n_A_INT*n_A_ActiveSkillLV,
      w_SBr[2]=w+1e3-Math.floor((n_B[14]+n_B[15]+n_B_MDEF2+n_B_DEF2[2])/2),
      ...
      for(var i=0;2>=i;i++)
        w_DMG[i]=BattleCalc(n_A_DMG[i],i),w_DMG[i]*=n_A_ActiveSkillLV,
      ...
      work_A_VITDEF=[0,0,0],work_A_VITDEF[0]=n_A_VITDEF[2],work_A_VITDEF[1]=n_A_VITDEF[1],work_A_VITDEF[2]=n_A_VITDEF[0],
      n_A_softMDEF=n_A_INT+Math.floor(n_A_VIT/2);
      for(var i=0;2>=i;i++)
        w_DMG[i]=BK_n_A_DMG[i]*(100-n_A_DEF)/100-work_A_VITDEF[i]+n_A_WeaponLV_seirenATK,
        w_DMG[i]=Math.floor(w_DMG[i]*(wbairitu+.4*n_A_ActiveSkillLV)),
        w=BK_n_A_MATK[i]*(100-n_A_MDEF)/100-n_A_softMDEF,
        w=Math.floor(w*(.4*n_A_ActiveSkillLV+1)),
        w_DMG[i]+=w,w_DMG[i]=Math.floor(w_DMG[i]*(100-n_tok[57])/100),
        w_DMG[i]=Math.floor(w_DMG[i]*(100-n_tok[66])/100),
        w_DMG[i]=Math.floor(w_DMG[i]*(100-n_tok[78])/100),
        eval(document.calcForm.A_youshi.checked)?
          w_DMG[i]=Math.floor(w_DMG[i]*(100-n_tok[190])/100):
          w_DMG[i]=Math.floor(w_DMG[i]*(100-n_tok[191])/100),
        w_DMG[i]=Math.floor(w_DMG[i]*zokusei[10*n_A_BodyZokusei+1][6]),
        w_DMG[i]=Math.floor(w_DMG[i]/2),
        EquipNumSearch(1433)&&(w_DMG[i]=Math.floor(1.172*w_DMG[i]));
      myInnerHtml("CRInum",'<Font color="#FF0000">3'+SubName[8]+w_DMG[0]+"~"+w_DMG[2]+" Damage</Font>",0),
      n_Enekyori=2,n_A_Weapon_zokusei=6,wCast=3*n_A_CAST,n_Delay[2]=1.5,wLAch=1;
      for(var i=0;2>=i;i++)
        w_DMG[i]=BK_n_A_DMG[i]*(100-n_B[14])/100-n_B_DEF2[i]+n_A_WeaponLV_seirenATK,
        w_DMG[i]*=wbairitu+.4*n_A_ActiveSkillLV,
        w_DMG[i]=Math.floor(w_DMG[i]*zokusei[n_B[3]][6]),
        w=BK_n_A_MATK[i]*(100-n_B[15])/100-n_B_MDEF2,
        w*=.4*n_A_ActiveSkillLV+1,
        w=Math.floor(w*zokusei[n_B[3]][6]),
        w_DMG[i]=tPlusDamCut(Math.floor((w+w_DMG[i])*zokusei[n_B[3]][6])),
        EquipNumSearch(1433)&&(w_DMG[i]=Math.floor(1.1*w_DMG[i])),
        w_DMG[i]<1&&(w_DMG[i]=1),
        60<=n_B[3]&&n_B[3]<=69&&(w_DMG[i]=0);
      if(0==n_B_IJYOU[6])
        for (var b=0;2>=b;b++)
          Last_DMG_A[b]=Last_DMG_B[b]=3*w_DMG[b],InnStr[b]+=Last_DMG_A[b]+" ("+w_DMG[b]+SubName[8]+"3hit)",w_DMG[b]=Last_DMG_A[b];
      else
        for (var b=0;2>=b;b++)
          Last_DMG_A[b]=Last_DMG_B[b]=4*w_DMG[b],InnStr[b]+=Last_DMG_A[b]+" ("+2*w_DMG[b]+" + "+w_DMG[b]+SubName[8]+"2hit)",w_DMG[b]=Last_DMG_A[b];
      w_HIT_HYOUJI=100,
      CastAndDelay(),BattleCalc998()
      ...
      for(var b=0;2>=b;b++)
        ...
        SRV&&(!CardNumSearch(523)||6!=n_A_JOB&&12!=n_A_JOB&&19!=n_A_JOB&&26!=n_A_JOB&&33!=n_A_JOB&&40!=n_A_JOB||(w_DMG[0]*=1.5,w_DMG[1]*=1.5,w_DMG[2]*=1.5)),
      ...
      n_PerHIT_DMG=0,n_A_Weapon_zokusei=0,
      ...
      n_PerHIT_DMG=0,w_HIT_HYOUJI=100,n_A_Weapon_zokusei=0,
      ATKbai02(wbairitu,0),
      wbairitu+=.75*n_A_ActiveSkillLV,
      work_B_DEF2=[0,0,0],work_B_DEF2[0]=n_B_DEF2[2],work_B_DEF2[1]=n_B_DEF2[1],work_B_DEF2[2]=n_B_DEF2[0];
      for(var b=0;2>=b;b++)
        w_DMG[b]=Math.floor(Math.floor(BK_n_A_DMG[b]*wbairitu)*(work_B_DEF2[b]+n_B[14])/50),
        w_DMG[b]=BaiCI(w_DMG[b]),
        w_DMG[b]=Math.floor(w_DMG[b]*zokusei[n_B[3]][0]),
        SRV?
          Last_DMG_A[b]=Last_DMG_B[b]=w_DMG[b]+EDP_DMG(b)+3*eval(document.calcForm.SkillSubNum.value):
          Last_DMG_A[b]=Last_DMG_B[b]=w_DMG[b]+EDP_DMG(b),InnStr[b]+=Last_DMG_A[b];
      EDPplus(1),
      wCast=1*n_A_CAST,
      n_Delay[2]=.5,
      CastAndDelay(),BattleCalc998()
      ...
      for(var b=0;2>=b;b++)
        ...
        w_DMG[b]=BaiCI(w_DMG[b]),
        w_DMG[b]=Math.floor(w_DMG[b]*zokusei[n_B[3]][0]),
        SRV&&(n_A_Buf6[5]&&(w_DMG[b]+=Math.floor((.02+.03*n_A_Buf6[5])*w_DMG[b])),
        n_A_Buf6[5]&&n_A_Buf7[31]?w_DMG[b]+=0:n_A_Buf7[31]&&(w_DMG[b]+=Math.floor(.05*w_DMG[b])),
        1==n_A_Buf2[19]&&(w_DMG[b]=2*w_DMG[b])),
        Last_DMG_A[b]=Last_DMG_B[b]=w_DMG[b]+EDP_DMG(b),
        InnStr[b]+=Last_DMG_A[b];
      EDPplus(1),
      ...
      n_PerHIT_DMG=0,n_A_Weapon_zokusei=0,n_Enekyori=1,
      ATKbai02(wbairitu,0),
      405==n_A_ActiveSkill?
      ...
      SRV?
        ...
        w_DMG[0]=40*(n_A_STR+n_A_ActiveSkillLV)+w_1senHP*(n_A_BaseLV/100)*n_A_ActiveSkillLV/10,
      ...
      n_PerHIT_DMG=0,not_use_card=1,n_Enekyori=1,n_A_Weapon_zokusei=0,
      ...
      for(var i=0;2>=i;i++)
        ...
        InnStr[i]+=Last_DMG_A[i]+" ("+Last_DMG_B[i]+SubName[8]+wHITsuu+"hit)",
        w_DMG[i]=Last_DMG_A[i];
      wCast=1*n_A_CAST,n_Delay[2]=1,w_HIT_HYOUJI=100,
      CastAndDelay(),BattleCalc998()
    }else if(106==n_A_ActiveSkill||112==n_A_ActiveSkill||113==n_A_ActiveSkill){
      n_PerHIT_DMG=0,n_Delay[0]=1,
      106==n_A_ActiveSkill?
        (n_A_Weapon_zokusei=2,w_DMG[2]=Math.floor((75+n_A_DEX)*(1+n_A_INT/100)*n_A_ActiveSkillLV*zokusei[n_B[3]][2])):
      112==n_A_ActiveSkill?
        (n_A_Weapon_zokusei=4,w_DMG[2]=Math.floor((50+n_A_DEX/2)*(1+n_A_INT/100)*n_A_ActiveSkillLV*zokusei[n_B[3]][4])):
      113==n_A_ActiveSkill&&
        (n_A_Weapon_zokusei=3,w_DMG[2]=Math.floor((75+n_A_DEX/2)*(1+n_A_INT/100)*n_A_ActiveSkillLV*zokusei[n_B[3]][3])),
      ...
      n_PerHIT_DMG=0,n_A_Weapon_zokusei=6,n_Delay[2]=1,n_Enekyori=2,
      ...
      n_PerHIT_DMG=0,n_A_Weapon_zokusei=6,wCast=5*n_A_CAST,n_Delay[0]=1,n_Enekyori=2,
      ...
      w_DMG[2]=Math.floor(w_DMG[2]*w_HEAL_BAI/100),w_DMG[2]=tPlusDamCut(w_DMG[2]),
      w_DMG[0]=w_DMG[1]=w_DMG[2];
      for(var i=0;2>=i;i++) Last_DMG_A[i]=Last_DMG_B[i]=w_DMG[i],InnStr[i]+=Last_DMG_A[i];
      w_HIT_HYOUJI=100,
      CastAndDelay(),BattleCalc998()
      ...
      InnStr[1]+=w_DMG[1]+"",
      InnStr[2]+=Math.floor(w_DMG[2]*zokusei[n_B[3]][n_A_Weapon_zokusei])+" ("+Math.floor(1e4*w)/100+"% Success Chance)",
      n_Delay[2]=3,w_HIT_HYOUJI=100,
      CastAndDelay(),BattleCalc998()
      ...
      wCast=5*n_A_CAST,n_Delay[2]=2,w_HIT_HYOUJI=100,
      CastAndDelay(),BattleCalc998()
    }else{
      if(n_PerHIT_DMG=0,n_Enekyori=2,wbairitu=1,n_bunkatuHIT=0,
        51==n_A_ActiveSkill?
          (n_A_Weapon_zokusei=3,wHITsuu=n_A_ActiveSkillLV,wCast=.7*n_A_ActiveSkillLV,n_Delay[2]=.8+.2*n_A_ActiveSkillLV):
        54==n_A_ActiveSkill?
          (n_A_Weapon_zokusei=1,wHITsuu=n_A_ActiveSkillLV,wCast=.7*n_A_ActiveSkillLV,n_Delay[2]=.8+.2*n_A_ActiveSkillLV):
        56==n_A_ActiveSkill?
          (n_A_Weapon_zokusei=4,wHITsuu=n_A_ActiveSkillLV,wCast=.7*n_A_ActiveSkillLV,n_Delay[2]=.8+.2*n_A_ActiveSkillLV):
        52==n_A_ActiveSkill?
          (n_A_Weapon_zokusei=3,n_A_ActiveSkillLV<=5?(wCast=1.5,n_Delay[2]=1.5):(wCast=1,n_Delay[2]=1),wbairitu=.7+.1*n_A_ActiveSkillLV):
        53==n_A_ActiveSkill?
          (n_A_Weapon_zokusei=3,wHITsuu=4+n_A_ActiveSkillLV,wCast=2.15-.15*n_A_ActiveSkillLV,n_Delay[2]=.1,wbairitu=.5):
        55==n_A_ActiveSkill?
          (n_A_Weapon_zokusei=1,wCast=.8,n_Delay[2]=1.5,wbairitu=1+.1*n_A_ActiveSkillLV):
        57==n_A_ActiveSkill?
          (n_A_Weapon_zokusei=4,wHITsuu=n_A_ActiveSkillLV,wCast=1*n_A_ActiveSkillLV,n_Delay[2]=2,wbairitu=.8):
        46==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=8,wCast=.5,
          10==n_A_ActiveSkillLV?n_Delay[2]=.5:
          9==n_A_ActiveSkillLV?n_Delay[2]=.6:
          8==n_A_ActiveSkillLV?n_Delay[2]=.7:
          n_A_ActiveSkillLV>=6?n_Delay[2]=.8:
          n_A_ActiveSkillLV>=4?n_Delay[2]=.9:n_Delay[2]=1,wbairitu=.7+.1*n_A_ActiveSkillLV
        ):
        47==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=8,wHITsuu=Math.round(n_A_ActiveSkillLV/2),wCast=.5,
          n_A_ActiveSkillLV%2==0?n_Delay[2]=.8+n_A_ActiveSkillLV/2*.2:n_Delay[2]=1+(n_A_ActiveSkillLV+1)/2*.2
        ):
        122==n_A_ActiveSkill?(n_A_Weapon_zokusei=3,wHITsuu=n_A_ActiveSkillLV+2,wCast=3.3-.3*n_A_ActiveSkillLV,n_Delay[2]=1,wbairitu=.2):
        124==n_A_ActiveSkill?(n_A_Weapon_zokusei=3,wCast=.7,n_Delay[2]=2,wbairitu=1+.2*n_A_ActiveSkillLV):
        125==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=3,wHITsuu=Math.round(n_A_ActiveSkillLV/2)*(Math.floor(n_A_ActiveSkillLV/2)+2),
          wCast=15,n_Delay[2]=1*Math.floor(n_A_ActiveSkillLV/2)+2
        ):
        126==n_A_ActiveSkill?(n_A_Weapon_zokusei=4,wHITsuu=n_A_ActiveSkillLV+2,wCast=2+.5*n_A_ActiveSkillLV):
        127==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=4,wHITsuu=4,wCast=15.5-.5*n_A_ActiveSkillLV,
          n_Delay[2]=5,n_Delay[6]=4,wbairitu=.8+.2*n_A_ActiveSkillLV
        ):
        128==n_A_ActiveSkill||320==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=1,n_A_ActiveSkillLV>=4?wHITsuu=25:n_A_ActiveSkillLV>=2&&(wHITsuu=9),
          SG_Special_HITnum=wHITsuu,wCast=n_A_ActiveSkillLV,wbairitu=1+.3*n_A_ActiveSkillLV,
          n_Delay[3]=.1*wHITsuu
        ):
        130==n_A_ActiveSkill?(
          wbairitu=.66+.066*n_A_ActiveSkillLV,n_A_Weapon_zokusei=1,wCast=6-.5*Math.floor((n_A_ActiveSkillLV-1)/2),
          n_Delay[2]=1
        ):
        131==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=1,wHITsuu=eval(document.calcForm.SkillSubNum.value),
          SG_Special_HITnum=wHITsuu,
          SRV?
            (10==n_A_Weapon_ATKplus&&EquipNumSearch(1169)?SGcast=.92:SGcast=1,wCast=(5+n_A_ActiveSkillLV)*SGcast):
            wCast=5+n_A_ActiveSkillLV,
          n_Delay[2]=5,n_Delay[6]=4.5,wbairitu=1+.4*n_A_ActiveSkillLV
        ):
        132==n_A_ActiveSkill||133==n_A_ActiveSkill||319==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=2,wHITsuu=n_A_ActiveSkillLV,
          132==n_A_ActiveSkill?
            (wCast=.7*n_A_ActiveSkillLV,n_Delay[2]=.8+.2*n_A_ActiveSkillLV):
            (wCast=n_A_ActiveSkillLV,n_Delay[2]=1)
        ):
        277==n_A_ActiveSkill?(wHITsuu=n_A_ActiveSkillLV,n_A_Weapon_zokusei=8,wCast=1,n_Delay[2]=1,wbairitu=.7+.1*n_A_ActiveSkillLV):
        37==n_A_ActiveSkill||387==n_A_ActiveSkill?(n_A_Weapon_zokusei=6,wCast=2,wbairitu=1.25,387==n_A_ActiveSkill&&(wbairitu*=5)):
        104==n_A_ActiveSkill?(
          n_Delay[0]=1,n_A_Weapon_zokusei=6,wHITsuu=n_A_ActiveSkillLV,wCast=15,
          n_Delay[2]=4,6!=n_B[2]&&n_B[3]<90&&(n_A_MATK[2]=0,n_A_MATK[0]=0,n_A_MATK[1]=0)
        ):
        312==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=7,wHITsuu=Math.round(n_A_ActiveSkillLV/2),wCast=.5,
          n_A_ActiveSkillLV%2==0?n_Delay[2]=.8+n_A_ActiveSkillLV/2*.2:n_Delay[2]=1+(n_A_ActiveSkillLV+1)/2*.2
        ):
        373==n_A_ActiveSkill?(
          ...
          8==n_A_Weapon_zokusei&&CardNumSearch(529)&&(wbairitu+=.5),
          1==Taijin&&(wbairitu=0)
        ):
        374==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=eval(document.calcForm.A_Weapon_zokusei.value),
        ...
        375==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=eval(document.calcForm.A_Weapon_zokusei.value),
          n_Delay[0]=1,wHITsuu=n_A_ActiveSkillLV,wCast=2,n_Delay[2]=.5,
          wbairitu=.4+n_A_BaseLV/100,
          8==n_A_Weapon_zokusei&&CardNumSearch(529)&&(wbairitu+=.5),
          1==Taijin&&(wbairitu=0)
        ):
        407==n_A_ActiveSkill?(n_A_Weapon_zokusei=3,wbairitu=.9,wHITsuu=n_A_ActiveSkillLV,wCast=.7*n_A_ActiveSkillLV):
        408==n_A_ActiveSkill?(
          n_A_Weapon_zokusei=3,wbairitu=.5,wHITsuu=Math.round(n_A_ActiveSkillLV/2)+4,wCast=6.5-.5*n_A_ActiveSkillLV,
          n_Delay[2]=1,n_Delay[0]=1
        ):
        409==n_A_ActiveSkill?(
          n_bunkatuHIT=1,n_A_Weapon_zokusei=3,wbairitu=1.5+1.5*n_A_ActiveSkillLV,
          wHITsuu=3,wCast=3,n_Delay[2]=3
        ):
        410==n_A_ActiveSkill?(n_A_Weapon_zokusei=1,wbairitu=1,wHITsuu=n_A_ActiveSkillLV+2,wCast=.7*n_A_ActiveSkillLV):
        412==n_A_ActiveSkill?(n_A_Weapon_zokusei=1,wbairitu=1+.5*n_A_ActiveSkillLV,wHITsuu=1,wCast=3,n_Delay[2]=3):
        413==n_A_ActiveSkill?(n_A_Weapon_zokusei=4,wbairitu=1,wHITsuu=Math.floor(n_A_ActiveSkillLV/2)+1,wCast=Math.floor(n_A_ActiveSkillLV/2)+1,n_Delay[2]=1):
        414==n_A_ActiveSkill?(n_A_Weapon_zokusei=4,wbairitu=1.6+.4*n_A_ActiveSkillLV,wHITsuu=1,wCast=4):
        415==n_A_ActiveSkill&&(n_A_Weapon_zokusei=4,wbairitu=1+1*n_A_ActiveSkillLV,wHITsuu=1,wCast=4),
        wCast*=n_A_CAST,0==n_bunkatuHIT
      )
        for (var b=0;2>=b;b++)
          w_DMG[b]=BattleMagicCalc(n_A_MATK[b]*wbairitu),
          0!=SG_Special_HITnum&&(SG_Special_DMG[b]=w_DMG[b]),
          Last_DMG_B[b]=w_DMG[b],Last_DMG_A[b]=w_DMG[b]*wHITsuu,
...
function ATKbai01(){
  ...
  197!=n_A_ActiveSkill&&
  321!=n_A_ActiveSkill&&(
    SkillSearch(12)?_+=32:n_A_Buf6[5]?_+=2+3*n_A_Buf6[5]:n_A_Buf7[31]&&(_+=5),
...
function ATKbai02(_,n){
  wA02=100*_,
  SkillSearch(327)?wA02+=20*SkillSearch(327):(
    SkillSearch(154)?wA02+=5*SkillSearch(154):n_A_Buf2[8]&&(wA02+=5*n_A_Buf2[8])
  ),
...
function BattleTAKA(){
  return 10==n_A_WeaponType&&SkillSearch(118)&&
    272!=n_A_ActiveSkill?(
...
function HealCalc(_,n){
  ...
  var i=100+n_tok[91];
  return 1==n&&(i+=n_tok[92]),
    EquipNumSearch(644)&&(i+=Math.floor(1.5*n_A_Weapon_ATKplus)),
    EquipNumSearch(565)&&n_A_HEAD_DEF_PLUS>=7&&(i+=1*EquipNumSearch(565)),
    EquipNumSearch(1277)&&n_A_HEAD_DEF_PLUS>=7&&(i+=3*EquipNumSearch(1277)),
    EquipNumSearch(1813)&&3==n_A_JobClass()&&(i+=5*EquipNumSearch(1813)),
    wHeal=Math.floor(wHeal*(i/100)*(1-20*n_A_Buf6[18]/100)),
    wHeal
}
function BattleCalc998(){
  if(
    n_PerHIT_DMG>0&&w_HIT_HYOUJI<100&&
    (str_bSUBname+="Damage When Missing",0==str_PerHIT_DMG?str_bSUB+=n_PerHIT_DMG:str_bSUB+=str_PerHIT_DMG),
  ...
  if(0!=SG_Special_HITnum){
    if(1==_){
      ...
      if(
        n=SG_Special_HITnum,
        e=(SG_Special_DMG[2]*wHITsuu-n_B[6])/(SG_Special_DMG[2]*wHITsuu-SG_Special_DMG[0]*wHITsuu),
        e>1&&(e=1),
        e<0&&(e=0),
        2==n&&(e=.5>e?2*e*e:1-2*(1-e)*(1-e)),
        3==n&&(
          e<1/3?e=4.5*Math.pow(e,3):
          e>=1/3&&e<2/3?e=4.5*(Math.pow(e,3)-3*Math.pow(e-1/3,3)):
          e>=2/3&&(e=1-4.5*Math.pow(1-e,3))
        ),
        n>=4
      ){
        var l=Math.sqrt(Math.pow(SG_Special_DMG[2]-SG_Special_DMG[0],2)/12*n);
        e=(SG_Special_DMG[1]*wHITsuu-n_B[6])/l,
        e=e>=0?
          .5+.5*Math.sqrt(1-Math.exp(-2*Math.pow(e,2)/Math.PI)):
          .5-.5*Math.sqrt(1-Math.exp(-2*Math.pow(e,2)/Math.PI))
      }
  ...
  if(1e4>_){
    ...
    n_Delay[0]?myInnerHtml("BattleTime","Special",0):myInnerHtml("BattleTime",a+"s",0)
  }else myInnerHtml("AveATKnum",SubName[5],0),myInnerHtml("BattleTime",SubName[6],0);
  var _=1/(wCast+wDelay)*w_DMG[1];
  _*=100,_=Math.round(_),_/=100,
  n_Delay[0]?myInnerHtml("AveSecondATK","Special",0):myInnerHtml("AveSecondATK",_,0),
  _=BattleHiDam(),
  _=Math.round(_*(100-n_A_LUCKY))/100,
  _=Math.round(_*(100-w_FLEE))/100,
  n_A_Buf2[13]&&(_=Math.round(_*w_AG[n_A_Buf2[13]])/100),
  3==n_A_WeaponType&&SkillSearch(255)&&(_=Math.round(_*(80-3*SkillSearch(255)))/100),
  SkillSearch(287)&&(_=Math.round(_*(100-7.5*SkillSearch(287)))/100),
  myInnerHtml("B_Ave2Atk",Math.round(100*_*BskillHitNum)/100,0)
}
function BattleHiDam(){
  var atkmod=100,matkmod=100,n_B_MATK=[0,0,0],
  w=Math.floor(n_B[9]/7); n_B_MATK[0]=n_B[9]+n_B_manual[42]+w*w, n_B_MATK[0]+=n_B_manual[43]*n_B_MATK[0]/100,
  w=Math.floor(n_B[9]/5), n_B_MATK[2]=n_B[9]+n_B_manual[42]+w*w, n_B_MATK[2]+=n_B_manual[43]*n_B_MATK[2]/ 100,
  n_B_MATK[1]=(n_B_MATK[2]+n_B_MATK[0])/2;
  var n_B_Weapon_zokusei=0;
  n_B_rangedAtk=0,n_B_rangedMAtk=0;
  var n_B_ignoreDef=0,n_B_ignoreMDef=0;
  ...
  if(
    ...
    if(BskillHitNum=3,n_B_rangedAtk=n_B_AtkSkill-444,n_B_ignoreDef=1,n_B_ignoreFlee=1,CardNumSearch(126)) atkmod=0;
      ...
      case 1:atkmod+=200;break;
      case 2:atkmod+=400;break;
      case 3:atkmod+=500;break;
      case 4:atkmod+=700;break;
      case 5:atkmod+=900;break;
      case 6:atkmod+=1100;break;
      case 7:atkmod+=1200;break;
      case 8:atkmod+=1400;break;
      case 9:atkmod+=1500;break;
      case 10:atkmod+=1700
    }
    ...
    n_B_MATK[0]=n_B[9]+w*w,w=Math.floor(n_B[9]/5),
    n_B_MATK[2]=n_B[9]+w*w,
    n_B_MATK[1]=(n_B_MATK[2]+n_B_MATK[0])/2,atkmod=n_B[9]
    ...
    n_B_rangedAtk=0,n_B_Weapon_zokusei=n_B_AtkSkill-490,
    CardNumSearch(n_B_AtkSkill-362)&&490!=n_B_AtkSkill&&497>=n_B_AtkSkill?atkmod=0:atkmod+=100*n_B_AtkSkillLV-100;
  else if(n_B_AtkSkill>=500&&509>=n_B_AtkSkill)
    n_B_rangedAtk=1,n_B_Weapon_zokusei=n_B_AtkSkill-500,
    CardNumSearch(n_B_AtkSkill-372)&&500!=n_B_AtkSkill&&507>=n_B_AtkSkill?atkmod=0:atkmod+=100*n_B_AtkSkillLV-100;
  ...
  else if(47==n_B_AtkSkill) n_B_rangedMAtk=1,n_B_Weapon_zokusei=8,BskillHitNum=Math.round(n_B_AtkSkillLV/2),
    (91==n_B[3]||92==n_B[3]||93==n_B[3]||94==n_B[3])&&(atkmod+=5*n_B_AtkSkillLV);
  ...
  else if(73==n_B_AtkSkill) w=20*n_B_AtkSkillLV+100,
    atkmod+=10==n_B_AtkSkillLV?462.5:n_B_AtkSkillLV>=7?w+w/2+w/4-100:n_B_AtkSkillLV>=4?w+w/2-100:w-100;
  else if(83==n_B_AtkSkill||388==n_B_AtkSkill) atkmod+=50*n_B_AtkSkillLV+200,
    388==n_B_AtkSkill&&0==Taijin&&(atkmod*=2),
    388==n_B_AtkSkill&&1==Taijin&&(atkmod*=n_Ses?1.25:2);
  ...
  else if(128==n_B_AtkSkill||320==n_B_AtkSkill) n_B_rangedMAtk=1,n_B_Weapon_zokusei=1,
    BskillHitNum=n_B_AtkSkillLV>=4?25:n_B_AtkSkillLV>=2?9:1,atkmod+=30*n_B_AtkSkillLV;
  ...
  else if(305==n_B_AtkSkill) atkmod+=100+n_A_BaseLV/3;
  else if(306==n_B_AtkSkill) n_B_rangedAtk=1;
  else if(307==n_B_AtkSkill) n_B_rangedAtk=1,atkmod+=50;
  else if(308==n_B_AtkSkill){var w; w=eval(document.calcForm.SkillSubNum.value),atkmod+=100*w}
  else
    326==n_B_AtkSkill?
      atkmod+=Math.floor(eval(document.calcForm.SkillSubNum.value)/(16-n_B_AtkSkillLV)/100*100):
    382==n_B_AtkSkill?
      atkmod+=200:
      atkmod=100;
  if(
    atkmod=0==SRV&&
    0==n_B_AtkSkill&&
    138==n_A_card[11]?atkmod:Math.floor(atkmod*zokusei[10*n_A_BodyZokusei+1][n_B_Weapon_zokusei]),
    w_HiDam=new Array,
    0==n_B_rangedMAtk?(
      wBHD=n_B[13],
      w_HiDam[0]=atkmod/100*n_B[12],
      w_HiDam[1]=atkmod/100*(5*n_B[12]+wBHD)/6,
      w_HiDam[2]=atkmod/100*(4*n_B[12]+2*wBHD)/6,
      w_HiDam[3]=atkmod/100*(n_B[12]+wBHD)/2,
      w_HiDam[4]=atkmod/100*(2*n_B[12]+4*wBHD)/6,
      w_HiDam[5]=atkmod/100*(n_B[12]+5*wBHD)/6,
      w_HiDam[6]=atkmod/100*wBHD,
      n_B[12]==n_B[13]&&(w_HiDam[6]=atkmod/100*wBHD-1),
      0==n_B_ignoreDef&&(
      ...
      wBHD=n_B_MATK[2],
      w_HiDam[0]=atkmod/100*n_B_MATK[0],
      w_HiDam[1]=atkmod/100*(5*n_B_MATK[0]+wBHD)/6,
      w_HiDam[2]=atkmod/100*(4*n_B_MATK[0]+2*wBHD)/6,
      w_HiDam[3]=atkmod/100*(n_B_MATK[0]+wBHD)/2,
      w_HiDam[4]=atkmod/100*(2*n_B_MATK[0]+4*wBHD)/6,
      w_HiDam[5]=atkmod/100*(n_B_MATK[0]+5*wBHD)/6,
      w_HiDam[6]=atkmod/100*wBHD,
      0==n_B_ignoreMDef&&(
        w_HiDam[0]=w_HiDam[0]*(100-n_A_MDEF)/100-n_A_softMDEF,
        w_HiDam[1]=w_HiDam[1]*(100-n_A_MDEF)/100-n_A_softMDEF,
        w_HiDam[2]=w_HiDam[2]*(100-n_A_MDEF)/100-n_A_softMDEF,
        w_HiDam[3]=w_HiDam[3]*(100-n_A_MDEF)/100-n_A_softMDEF,
        w_HiDam[4]=w_HiDam[4]*(100-n_A_MDEF)/100-n_A_softMDEF,
        w_HiDam[5]=w_HiDam[5]*(100-n_A_MDEF)/100-n_A_softMDEF,
        w_HiDam[6]=w_HiDam[6]*(100-n_A_MDEF)/100-n_A_softMDEF
      )
    ),
    SkillSearch(23)&&(n_B[3]>=90||6==n_B[2])
  )
  ...
  if(wBHD=n_tok[330+Math.floor(n_B[3]/10)],0!=wBHD)
    for(i=0;6>=i;i++) w_HiDam[i]-=Math.floor(w_HiDam[i]*wBHD/100);
  for(wBHD=StPlusCard(3e3+n_B[0]),wBHD+=StPlusCalc2(3e3+n_B[0]),i=0;6>=i;i++)
    w_HiDam[i]-=Math.floor(w_HiDam[i]*wBHD/100);
  if(n_A_Buf7[22]&&MANUKU_MONSTER()) for(i=0;6>=i;i++) w_HiDam[i]-=Math.floor(w_HiDam[i]/10);
  if(n_A_Buf7[25]&&SUPURE_MONSTER()) for(i=0;6>=i;i++) w_HiDam[i]-=Math.floor(w_HiDam[i]/10);
  ...
  if(488==n_B_AtkSkill) for(i=0;6>=i;i++) w_HiDam[i]=Math.floor(n_B_AtkSkillLV*n_A_MaxHP/10);
  if(489==n_B_AtkSkill) for(n_B_Weapon_zokusei=3,wBHD=n_tok[60+n_B_Weapon_zokusei],i=0;6>=i;i++)
    w_HiDam[i]=1*document.calcForm.BSkillSubNum.value-Math.floor(document.calcForm.BSkillSubNum.value*wBHD/100);
  for(
    myInnerHtml(
      "B_WeaponElement",
      ZokuseiOBJ[n_B_Weapon_zokusei]+" ("+100*zokusei[10*n_A_BodyZokusei+1][n_B_Weapon_zokusei]+"% vs "+ZokuseiOBJ[n_A_BodyZokusei]+"1)",
      0
    ),
    wBHD=0,i=0;6>=i;i++
  ) wBHD+=w_HiDam[i];
  wBHD=Math.round(wBHD/7);
  var name67="Minimum Damage Received",name65="Average Damage Received",name68="Maximum Damage Received",
    wRefStr1="",wRefStr0="",wRefStr2="",asm=1;
  if(n_A_Buf2[14]){
    var wRSnum=(10+3*n_A_Buf2[14])*asm,wRef1=new Array;
    wRef1[0]=Math.floor(wBHD*wRSnum/100),0==wRef1[0]&&(wRef1[0]=1),
    wRef1[1]=Math.floor(w_HiDam[0]*wRSnum/100),0==wRef1[1]&&(wRef1[1]=1),
    wRef1[2]=Math.floor(w_HiDam[6]*wRSnum/100),0==wRef1[2]&&(wRef1[2]=1),
    wRefStr1+="<BR><B style='color:blue'>"+wRef1[1]+"</B>",
    wRefStr0+="<BR><B style='color:blue'>"+wRef1[0]+"</B>",
    wRefStr2+="<BR><B style='color:blue'>"+wRef1[2]+"</B>",
    name67+="<BR><B style='color:blue'>Min Dmg Reflected (Shield Reflect)</B>",
    name65+="<BR><B style='color:blue'>Avg Dmg Reflected (Shield Reflect)</B>",
    name68+="<BR><B style='color:blue'>Max Dmg Reflected (Shield Reflect)</B>"
  }
  if(n_tok[71]){
    var wRef2=new Array, w=n_tok[71]*asm;
    wRef2[0]=Math.floor(wBHD*w/100),0==wRef2[0]&&(wRef2[0]=1),
    wRef2[1]=Math.floor(w_HiDam[0]*w/100),0==wRef2[1]&&(wRef2[1]=1),
    wRef2[2]=Math.floor(w_HiDam[6]*w/100),0==wRef2[2]&&(wRef2[2]=1),
    wRefStr1+="<BR><B style='color:blue'>"+wRef2[1]+"</B>",
    wRefStr0+="<BR><B style='color:blue'>"+wRef2[0]+"</B>",
    wRefStr2+="<BR><B style='color:blue'>"+wRef2[2]+"</B>",
    name67+="<BR><B style='color:blue'>Min Dmg Reflected (Equip/Cards)</B>",
    name65+="<BR><B style='color:blue'>Avg Dmg Reflected (Equip/Cards)</B>",
    name68+="<BR><B style='color:blue'>Max Dmg Reflected (Equip/Cards)</B>"
  }
  return myInnerHtml("nm067",name67,0),
    myInnerHtml("nm065",name65,0),
    myInnerHtml("nm068",name68,0),
    BskillHitNum>1?(
      myInnerHtml("B_MinAtk",w_HiDam[0]*BskillHitNum+" ("+w_HiDam[0]+" x "+BskillHitNum+")"+wRefStr1,0),
      myInnerHtml("B_AveAtk",wBHD*BskillHitNum+" ("+wBHD+" x "+BskillHitNum+")"+wRefStr0,0),
      myInnerHtml("B_MaxAtk",w_HiDam[6]*BskillHitNum+" ("+w_HiDam[6]+" x "+BskillHitNum+")"+wRefStr2,0)
    ):(
      myInnerHtml("B_MinAtk",w_HiDam[0]+wRefStr1,0),
      myInnerHtml("B_AveAtk",wBHD+wRefStr0,0),
      myInnerHtml("B_MaxAtk",w_HiDam[6]+wRefStr2,0)
    ),
    wBHD
}
function BattleMagicCalc(_){
  ...
  SRV?
    ...
    90<=n_B[3]&&47==n_A_ActiveSkill&&(wBMC2=Math.floor(wBMC2*(1+.05*n_A_ActiveSkillLV)));
  var e=n_tok[170+n_B[2]];
  9==n_B[2]&&SkillSearch(234)&&(e+=2*SkillSearch(234)),
  ...
  return (46==n_A_ActiveSkill||47==n_A_ActiveSkill||277==n_A_ActiveSkill)&&5==n_A_JobClass()&&(e+=20*CardNumSearch(474)),
    (132==n_A_ActiveSkill||133==n_A_ActiveSkill)&&EquipNumSearch(1146)&&(e+=n_A_HEAD_DEF_PLUS),
    131==n_A_ActiveSkill&&EquipNumSearch(1169)&&(e+=n_A_Weapon_ATKplus),
    (37==n_A_ActiveSkill||387==n_A_ActiveSkill)&&3==n_A_JobClass()&&EquipNumSearch(1247)&&(e+=5,n_A_HEAD_DEF_PLUS>=7&&(e+=5)),
    wBMC2=wBMC2*(100+e)/100,
...
function ClickJob(n){
  with(document.calcForm){
    ...
    if(
      n_SkillSW&&(
        45==n_A_JOB?(
          ...
          A2_Skill12.disabled=!0,A2_Skill12.value=0,n_A_Buf2[12]=0
        ):(
          myInnerHtml("AS12_1","# of Spirit Spheres",0),
          A2_Skill12.disabled=!1
        ),
        13==n_A_JOB||27==n_A_JOB?(
          myInnerHtml("AS11_1","<S>Providence</S>",0),
          A2_Skill11.disabled=!0,A2_Skill11.value=0,n_A_Buf2[11]=0
        ):(
          myInnerHtml("AS11_1","Providence",0),A2_Skill11.disabled=!1
        )
      ),
      n_Skill7SW
    ){
      A_SpeedPOT.options[3]=null; A_SpeedPOT.options[2]=null;
      3!=n_A_JOB&&9!=n_A_JobClass2()&&16!=n_A_JobClass2()?
        A_SpeedPOT.options[2]=new Option(SpeedPotName[2],2):
        A_SpeedPOT.options[2]=new Option("-",0),
      1==n_A_JobClass()||6==n_A_JobClass()||41==n_A_JobClass()||14==n_A_JobClass2()||11==n_A_JobClass2()||5==n_A_JOB||45==n_A_JOB?
    ...
    for(
      ...
      SuperNoviceFullWeaponCHECK?JobASPD[20][7]=120:JobASPD[20][7]=0,
      0==SRV&&8==n_A_JobClass2()&&1==n_Nitou&&(n_Nitou=0,ClickWeaponType2(0)),
      i=21;i>=0;i--
    ) A_WeaponType.options[i]=null;
    for(j=0,i=0;21>=i;i++) 0!=JobASPD[n][i]&&(A_WeaponType.options[j]=new Option(WeaponName[i],i),j++);
    for(ClickWeaponType(0),i=0;14>=i;i++)
      392==JobSkillPassOBJ[n][i]?(
        ...
        0==n_Tensei&&myInnerHtml("P_Skill"+i,"",0)
      ):999!=JobSkillPassOBJ[n][i]?(
        myInnerHtml("P_Skill"+i,SkillOBJ[JobSkillPassOBJ[n][i]][2],0),
    ...
    if(58==JobSkillPassOBJ[n][0]){
      ...
      for(n_ECname=["0","6% Reduction","12% Reduction","18% Reduction","24% Reduction","30% Reduction"],i=0;5>=i;i++)
    ...
    for(i=A_ActiveSkill.length-1;i>=0;i--) A_ActiveSkill.options[i]=null;
    for(i=0;999!=JobSkillActiveOBJ[n][i];i++)
...
function Bskill(){
  with(document.calcForm){
    var BskillLen=0;
    for(B_AtkSkill.options.length=0,B_AtkSkill.options[0]=new Option("Basic Attack",0),i=23;0!=MonsterOBJ[B_Enemy.value][i];i+=2)
      BskillLen++,
      B_AtkSkill.options[BskillLen]=
        new Option(SkillOBJ[MonsterOBJ[B_Enemy.value][i]][2]+" Lv "+MonsterOBJ[B_Enemy.value][i+1],MonsterOBJ[B_Enemy.value][i]);
...
function ClickWeaponType(n){
  with(document.calcForm){
    ...
    if(10==n||14==n||15==n) for(j=23,i=0;4>=i;i++) ArrowOBJ[i]=ArrowOBJbackup[i];
    else if(17==n||18==n||19==n||20==n) for(j=2,i=0;2>=i;i++) ArrowOBJ[i]=BulletOBJ[i];
    else if(21==n) for(j=4,i=0;4>=i;i++) ArrowOBJ[i]=GrenadeOBJ[i];
    ...
    WeaponSet(),
    0==n?(A_Weapon_ATKplus.disabled=!0,A_Weapon_ATKplus.value=0):A_Weapon_ATKplus.disabled=!1,
    n_A_JobSet(),
    8!=n_A_JOB&&22!=n_A_JOB||11==n?(
      ...
      myInnerHtml(
        "A_SobWeaponName",
        'Left Hand: <select name="A_Weapon2Type" onChange="ClickWeaponType2(this[this.selectedIndex].value)|StAllCalc()|restrictCardslot(1)"><option value="0">Fist or Shield<option value="1">Dagger<option value="2">Sword<option value="6">Axe</select>',
        0
      ),
...
function ClickWeaponType2(n){
  with(document.calcForm){
    if(n_A_JobSet(),0!=n){
      if(0==n_Nitou){
        for(
          myInnerHtml("spanA_weapon2",'<select name="A_weapon2" onChange="StAllCalc()|ClickB_Item(this[this.selectedIndex].value)|restrictCardslot(1)"></select>',0),
        ...
        for(
          myInnerHtml("nA_weapon2_c1",'<select name="A_weapon2_card1" onChange="StAllCalc()|Card(this[this.selectedIndex].value)"></select>',0),
          ...
          myInnerHtml("nA_weapon2_c4",'<select name="A_weapon2_card4" onChange="StAllCalc()|Card(this[this.selectedIndex].value)"></select>',0), i = 0;
          "NULL"!=CardSortOBJ[0][i];i++
        ){
          A_weapon2_card1.options[i]=new Option(cardOBJ[CardSortOBJ[0][i]][2],cardOBJ[CardSortOBJ[0][i]][0]);
        }
        for(i=0;"NULL"!=CardSortOBJ[1][i];i++)
        ...
        A_weapon2_card4.options[1]=new Option("TOP10 Ranked",106);
      }
      for(
        ...
        A_cardshortLeft.options[0]=new Option("(Left Hand Card Shortcuts)",0),
        A_cardshortLeft.options[1]=new Option("Remove Left Hand Cards",1),
        i=3;51>=i;i++
      ) A_cardshortLeft.options[i-1]=new Option(CardShort[i][0],i-1);
      n_Nitou=1,
      WeaponSetLeft()
    }else{
      myInnerHtml("spanA_weapon2","",0),
...
function ClickActiveSkill(){
  with(document.calcForm){
    ...
    n_A_ActiveSkill>=3e3?
      (n_A_ActiveSkillLV=InsertSkill[n_A_ActiveSkill-3e3][3],n_A_ActiveSkill=InsertSkill[n_A_ActiveSkill-3e3][2]):
    n_A_ActiveSkill>=2e3?
      (n_A_ActiveSkillLV=AutoSpellSkill[n_A_ActiveSkill-2e3][3],n_A_ActiveSkill=AutoSpellSkill[n_A_ActiveSkill-2e3][2]):
      (n_A_ActiveSkillLV=SkillOBJ[n_A_ActiveSkill][1],0==SRV&&(14!=n_A_JobClass2()||128!=n_A_ActiveSkill&&133!=n_A_ActiveSkill||(n_A_ActiveSkillLV=10)));
    ...
    1==SkillOBJ[n_A_ActiveSkill][1]?
      A_ActiveSkillLV.style.visibility="hidden":
      (A_ActiveSkillLV.style.visibility="visible",A_ActiveSkillLV.value=n_A_ActiveSkillLV),
    ClickActiveSkill2()
  }
}
function BClickAtkSkill(){
  with(document.calcForm){
    ...
    if(444==n_B_AtkSkill||445==n_B_AtkSkill){
      for(myInnerHtml("BBSkill",'Players in Range: <select name="BSkillSubNum" onChange="calc()"></select>',0),i=1;99>=i;i++)
        BSkillSubNum.options[i-1]=new Option(i,i);
    }else if(489==n_B_AtkSkill)
      myInnerHtml("BBSkill",'Enemy Remaining HP: <input type="text" name="BSkillSubNum" onkeyup="calc()" value="'+n_B[6]+'" size="7" class="center">',0);
      ...
      for(myInnerHtml("BBSkill",'Hits: <select name="BSkillSubNum" onChange="calc()"></select>',0),i=1;15>=i;i++)
        BSkillSubNum.options[i-1]=new Option(i,i);
      BSkillSubNum.value=3
    }else if(484==n_B_AtkSkill){
      for(myInnerHtml("BBSkill",'Element: <select name="BSkillSubNum" onChange="calc()"></select>',0),i=0;9>=i;i++)
        BSkillSubNum.options[i]=new Option(ZokuseiOBJ2[i],i);
...
function ClickActiveSkill2(){
  with(document.calcForm)
    if(66==n_A_ActiveSkill||326==n_A_ActiveSkill)
      myInnerHtml("AASkill",'Cart Weight: <input type="text" name="SkillSubNum" value="8000" size=2 onkeyup="calc()">',0);
    else if(131==n_A_ActiveSkill){
      for(myInnerHtml("AASkill",'Hits: <select name="SkillSubNum" onChange="calc()"></select>',0),i=1;15>=i;i++)
        SkillSubNum.options[i-1]=new Option(i,i);
      SkillSubNum.value=3
    }else if(88==n_A_ActiveSkill){
      for(myInnerHtml("AASkill",'Poison React Lv: <select name="SkillSubNum" onChange="calc()"></select>',0),i=0;10>=i;i++)
        SkillSubNum.options[i]=new Option(i,i);
      SkillSubNum.value=0,
      14==n_A_JobClass2()&&(SkillSubNum.value=0)
    }else if(197==n_A_ActiveSkill)
      myInnerHtml("AASkill",'Remaining SP: <input type="text" name="SkillSubNum" size=2 onkeyup="calc()">',0),
      SkillSubNum.value=n_A_MaxSP-1;
    else if(394==n_A_ActiveSkill){
      for(myInnerHtml("AASkill",'<select name="SkillSubNum" onChange="calc()"></select>',0),i=0;4>=i;i++)
      ...
      myInnerHtml("AASkill",'Remaining HP: <input type="text" name="SkillSubNum" size=3 onkeyup="calc()">',0),
      SkillSubNum.value=n_A_MaxHP-1;
    else if(429==n_A_ActiveSkill){
      var DEATH=["1","1.2","1.6","2","2.4","3","3.6","4","5","6","7","8","9","10"];
      for(myInnerHtml("AASkill",'Hits (Considering the Success Chance): <select name="SkillSubNum" onChange="calc()"></select>',0),i=0;13>=i;i++)
      ...
      for(myInnerHtml("AASkill",'Spheres Left: <select name="SkillSubNum" onChange="calc()"></select>',0),i=1;5>=i;i++)
        SkillSubNum.options[i-1]=new Option(i,i);
      SkillSubNum.value=5
...
function theme() {
  ...
  for(var n=document.querySelectorAll("h1"),e=0;e<n.length;e++)
    n[e].style.backgroundImage="linear-gradient(to bottom, "+hBGC1[_]+", "+hBGC2[_]+")";
  for(var i=document.querySelectorAll("h3"),e=0;e<i.length;e++)
    i[e].style.backgroundImage="linear-gradient(to bottom, "+hBGC1[_]+", "+hBGC2[_]+")";
  for(var l=document.querySelectorAll(".links"),e=0;e<l.length;e++)
    l[e].style.backgroundImage="linear-gradient(to bottom, "+hBGC1[_]+", "+hBGC2[_]+")";
  document.querySelectorAll("select");
  addCSSRule(document.styleSheets[1],"select","background-color:"+selBGC[_]+";");
  for(var t=document.querySelectorAll(".subheader select"),e=0;e<t.length;e++)
    t[e].style.backgroundColor=ssBGC[_];
  ...
  with(document.calcForm){
    if (n_SkillSW=v,n_SkillSW){
      ...
      for(
        ...
        str+='<TR><TD id="A2TD" ColSpan="6" class="subheader point" onclick="BufSW(0)">Supportive / Party Skills <span id="A2used"></span>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+='<TR class="center">',
        str+='<TD ColSpan="2" class="data"><B><U>Gospel Effects</U></B></TD>',
        str+='<TD ColSpan="2" class="data"><B><U>Acolyte Class Buffs</U></B></TD>',
        str+='<TD ColSpan="2"><B><U>Other Party Buffs</U></B></TD>',
        str+="</TR><TR>",
        str+='<TD id="EN50"></TD><TD id="" class="data"></TD>',
        str+='<TD id="AS0_1" class="center">Blessing</TD><TD id="AS0_2" class="data"></TD>',
        str+='<TD id="AS6_1" class="center">Adrenaline Rush</TD><TD id="AS6_2" class="data"></TD>',
        str+="</TR><TR>",
        str+='<TD id="EN51"></TD><TD id="" class="data"></TD>',
        str+='<TD id="AS1_1" class="center">Increase Agi</TD><TD id="AS1_2" class="data"></TD>',
        str+='<TD id="AS7_1" class="center">Weapon Perfection</TD><TD id="AS7_2"></TD>',
        str+="</TR><TR>",
        str+='<TD id="EN52"></TD><TD id="" class="data"></TD>',
        str+='<TD id="AS4_1" class="center">Angelus</TD><TD id="AS4_2" class="data"></TD>',
        str+='<TD id="AS8_1" class="center">Power Thrust</TD><TD id="AS8_2" class="data"></TD>',
        str+="</TR><TR>",
        str+='<TD id="EN53"></TD><TD id="" class="data"></TD>',
        str+='<TD id="AS2_1" class="center">Impositio Manus</TD><TD id="AS2_2" class="data"></TD>',
        str+='<TD id="AS9_1" class="center">Wind Walker</TD><TD id="AS9_2"></TD>',
        str+="</TR><TR>",
        str+='<TD id="EN55"></TD><TD id="" class="data"></TD>',
        ...
        str+="</TR><TR>",
        str+='<TD id="EN54"></TD><TD id="" class="data"></TD>',
      ...
      for(i=0;5>=i;i++)
        ...
        A2_Skill11.options[i]=new Option(i,i),
        A2_Skill12.options[i]=new Option(i,i),
        A2_Skill15.options[i]=new Option(i,i);
      for(
        45==n_A_JOB?(
          myInnerHtml("AS12_1","<S># of Spirit Spheres</S>",0),
          A2_Skill12.disabled=!0,A2_Skill12.value=0,
          n_A_Buf2[12]=0
        ):(
          myInnerHtml("AS12_1","# of Spirit Spheres",0),
          A2_Skill12.disabled=!1
        ...
        13==n_A_JOB||27==n_A_JOB?(
          myInnerHtml("AS11_1","<S>Providence</S>",0),
          A2_Skill11.disabled=!0,A2_Skill11.value=0,
          n_A_Buf2[11]=0
        ):(
          myInnerHtml("AS11_1","Providence",0),
          A2_Skill11.disabled=!1
        ),
        i=0;3>=i;i++
      ...
      A2_Skill0.value=n_A_Buf2[0],
      A2_Skill1.value=n_A_Buf2[1],
      A2_Skill2.value=n_A_Buf2[2],
      A2_Skill3.checked=n_A_Buf2[3],
      A2_Skill4.value=n_A_Buf2[4],
      A2_Skill5.checked=n_A_Buf2[5],
      A2_Skill6.value=n_A_Buf2[6],
      A2_Skill7.checked=n_A_Buf2[7],
      A2_Skill8.checked=n_A_Buf2[8],
      A2_Skill9.value=n_A_Buf2[9],
      A2_Skill10.value=n_A_Buf2[10],
      A2_Skill11.value=n_A_Buf2[11],
      A2_Skill12.value=n_A_Buf2[12],
      A2_Skill13.value=n_A_Buf2[13],
      A2_Skill14.value=n_A_Buf2[14],
      A2_Skill15.value=n_A_Buf2[15],
      A5_Skill0.checked=n_A_Buf2[16],
      A5_Skill1.checked=n_A_Buf2[17],
      A5_Skill2.checked=n_A_Buf2[18],
      A5_Skill3.checked=n_A_Buf2[19],
      A5_Skill4.checked=n_A_Buf2[20],
      A5_Skill5.checked=n_A_Buf2[21]
    }else{
      var str;
      str='<table class="tborder">',
      str+='<TR><TD id="A2TD" class="subheader point" onclick="BufSW(1)">Supportive / Party Skills <span id="A2used"></span>',
...
function A2(_){
  ...
  for(var n=0,e=0;21>=e;e++)
    if(0!=n_A_Buf2[e]){n=1;break}
  var i=document.getElementById("theme").value;
  0==n?
    (document.getElementById("A2TD").style.backgroundColor=sBGC[i],myInnerHtml("A2used","",0)):
    (document.getElementById("A2TD").style.backgroundColor=saBGC[i],myInnerHtml("A2used","<B>[Active]</B>",0))
}
function Buf3SW(v){
  with(document.calcForm){
    if (n_Skill3SW=v,n_Skill3SW){
      ...
      for(
        str = '<table class="tborder">',
        str+='<TR><TD id="A3TD" ColSpan="6" class="subheader point" onclick="Buf3SW(0)">Music and Dance Skills <span id="A3used"></span>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+='<TR><TD id="EN0_1"></TD><TD id="EN0_2" class="data"></TD><TD id="EN0_3"></TD><TD id="EN0_4" class="data"></TD><TD id="EN0_5"></TD><TD id="EN0_6"></TD></TR>',
        str+='<TR><TD id="EN1_1"></TD><TD id="EN1_2" class="data"></TD><TD id="EN1_3"></TD><TD id="EN1_4" class="data"></TD><TD id="EN1_5"></TD><TD id="EN1_6"></TD></TR>',
        str+='<TR><TD id="EN2_1"></TD><TD id="EN2_2" class="data"></TD><TD id="EN2_3" style="line-height:165%;"></TD><TD id="EN2_4" class="data"></TD><TD id="EN2_5"></TD><TD id="EN2_6"></TD></TR>',
        str+='<TR><TD id="EN3_1"></TD><TD id="EN3_2" class="data"></TD><TD id="EN3_3"></TD><TD id="EN3_4" class="data"></TD><TD id="EN3_5"></TD><TD id="EN3_6"></TD></TR>',
        str += '<TR><TD id="EN4_1"></TD><TD id="EN4_2" class="data"></TD><TD id="EN4_3"></TD><TD id="EN4_4" class="data"></TD><TD id="EN4_5"></TD><TD id="EN4_6"></TD></TR>',
        str += '<TR><TD id="EN5_1"></TD><TD id="EN5_2" class="data"></TD><TD id="EN5_3"></TD><TD id="EN5_4" class="data"></TD><TD id="EN5_5"></TD><TD id="EN5_6"></TD></TR>',
        str += '<TR class="dotB"><TD id="EN6_1"></TD><TD id="EN6_2" class="data"></TD><TD id="EN6_3"></TD><TD id="EN6_4" class="data"></TD><TD id="EN6_5"></TD><TD id="EN6_6"></TD></TR>',
        str += '<TR><TD id="EN7_1"></TD><TD id="EN7_2" class="data"></TD><TD id="EN8_1" ColSpan="2"></TD><TD id="EN8_2"></TD><TD></TD></TR>',
        str += '<TR class="dotB"><TD id="EN9_1"></TD><TD id="EN9_2" class="data"></TD><TD id="EN10_1" ColSpan="2"></TD><TD id="EN10_2"></TD><TD></TD></TR>',
        str += '<TR><TD colspan=6><span id="EN11_1"></span><span id="EN11_2"></span><span id="EN11_1a"></span></TD></TR></TABLE>',
      ...
      for(
        myInnerHtml("EN0_2",'<select name="A3_Skill0_1" onChange="Skill3SW_2()|A3(1)"></select>',0),
      ...
      A3_Skill0_1.value=n_A_Buf3[0],
      A3_Skill1_1.value=n_A_Buf3[1],
      A3_Skill2_1.value=n_A_Buf3[2],
      A3_Skill3_1.value=n_A_Buf3[3],
      A3_Skill4_1.value=n_A_Buf3[4],
      A3_Skill5_1.value=n_A_Buf3[5],
      A3_Skill6_1.value=n_A_Buf3[6],
      A3_Skill7.value=n_A_Buf3[7],
      A3_Skill8.value=n_A_Buf3[8],
      A3_Skill9.value=n_A_Buf3[9],
      A3_Skill10.value=n_A_Buf3[10],
      A3_Skill11.checked=n_A_Buf3[11],
      Skill3SW_2()
    }else{
      var str;
      for(
        str='<table class="tborder">',
        str+='<TR><TD id="A3TD" class="subheader point" onclick="Buf3SW(1)">Music and Dance Skills <span id="A3used"></span>',
        str+='<div class="right">(click to show)</div></TD></TR></TABLE>',
        myInnerHtml("SP_SIEN01",str,0),
        i=0;11>=i;i++
      ) SWs3sw[i]=0
...
function Skill3SW_2(){
  with(document.calcForm){
    if(
      ...
      if(0==SWs3sw[0]){
        for(
          0==n_A_Buf3[20]&&(n_A_Buf3[20]=100,n_A_Buf3[30]=10),
        ...
        SWs3sw[0]=1,
        A3_Skill0_2.value=n_A_Buf3[20],
        A3_Skill0_3.value=n_A_Buf3[30]
      }
    }else
      SWs3sw[0]=0,
      myInnerHtml("EN0_3","",0),
    ...
    if(0!=n_A_Buf3[1]){
      if(0==SWs3sw[1]){
        for(
          0==n_A_Buf3[21]&&(n_A_Buf3[21]=100,n_A_Buf3[31]=10),
        ...
        SWs3sw[1]=1,
        A3_Skill1_2.value=n_A_Buf3[21],
        A3_Skill1_3.value=n_A_Buf3[31]
      }
    }else
      SWs3sw[1]=0,
      myInnerHtml("EN1_3","",0),
    ...
    if(0!=n_A_Buf3[2]){
      if(0==SWs3sw[2]){
        for(
          0==n_A_Buf3[22]&&(n_A_Buf3[22]=100,n_A_Buf3[29]=100,n_A_Buf3[32]=10),
        ...
        SWs3sw[2]=1,
        A3_Skill2_2.value=n_A_Buf3[22],
        A3_Skill2_3.value=n_A_Buf3[29],
        A3_Skill2_4.value=n_A_Buf3[32]
      }
    }else
      SWs3sw[2]=0,
      myInnerHtml("EN2_3","",0),
    ...
    if(0!=n_A_Buf3[3]){
      if(0==SWs3sw[3]){
        for(
          0==n_A_Buf3[23]&&(n_A_Buf3[23]=100,n_A_Buf3[33]=10),
        ...
        SWs3sw[3]=1,
        A3_Skill3_2.value=n_A_Buf3[23],
        A3_Skill3_3.value=n_A_Buf3[33]
      }
    }else
      SWs3sw[3]=0,
      myInnerHtml("EN3_3","",0),
    ...
    if(0!=n_A_Buf3[4]){
      if(0==SWs3sw[4]){
        for(
          0==n_A_Buf3[24]&&(n_A_Buf3[24]=130,n_A_Buf3[34]=10),
        ...
        SWs3sw[4]=1,
        A3_Skill4_2.value=n_A_Buf3[24],
        A3_Skill4_3.value=n_A_Buf3[34]
      }
    }else
      SWs3sw[4]=0,
      myInnerHtml("EN4_3","",0),
    ...
    if(0!=n_A_Buf3[5]){
      if(0==SWs3sw[5]){
        for(
          0==n_A_Buf3[25]&&(n_A_Buf3[25]=50,n_A_Buf3[35]=10),
        ...
        SWs3sw[5]=1,
        A3_Skill5_2.value=n_A_Buf3[25],
        A3_Skill5_3.value=n_A_Buf3[35]
      }
    }else
      SWs3sw[5]=0,
      myInnerHtml("EN5_3","",0),
    ...
    if(0!=n_A_Buf3[6]){
      if(0==SWs3sw[6]){
        for(
          0==n_A_Buf3[26]&&(n_A_Buf3[26]=50,n_A_Buf3[36]=10),
        ...
        SWs3sw[6]=1,
        A3_Skill6_2.value=n_A_Buf3[26],
        A3_Skill6_3.value=n_A_Buf3[36]
      }
    } else
      SWs3sw[6]=0,
      myInnerHtml("EN6_3","",0),
    ...
    if(0!=n_A_Buf3[11]){
      if(0==SWs3sw[11]){
        ...
        SWs3sw[11]=1,
        A3_Skill11_STR.value=n_A_Buf3[12],
        A3_Skill11_AGI.value=n_A_Buf3[13],
        A3_Skill11_VIT.value=n_A_Buf3[14],
        A3_Skill11_INT.value=n_A_Buf3[15],
        A3_Skill11_DEX.value=n_A_Buf3[16],
        A3_Skill11_LUK.value=n_A_Buf3[17],
        A3_Skill11a.checked=n_A_Buf3[18]
      }
...
function A3(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("A3TD").style.backgroundColor=sBGC[i],
    myInnerHtml("A3used","",0)
  ):(
    document.getElementById("A3TD").style.backgroundColor=saBGC[i],
...
function Buf4SW(v){
  with(document.calcForm){
    if(n_Skill4SW=v,n_Skill4SW){
      ...
      for(
        str='<table class="tborder">',
        str+='<TR><TD id="A4TD" ColSpan="2" class="subheader point" onclick="Buf4SW(0)">Guild Skills <span id="A4used"></span>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+='<TR><TD id="EN40_1" class="center"></TD><TD id="EN40_2"></TD></TR>',
        str+='<TR><TD id="EN41_1" class="center"></TD><TD id="EN41_2"></TD></TR>',
        str+='<TR><TD id="EN42_1" class="center"></TD><TD id="EN42_2"></TD></TR>',
        str+='<TR><TD id="EN43_1" class="center"></TD><TD id="EN43_2"></TD></TR>',
        str+='<TR><TD id="EN44_1" class="center"></TD><TD id="EN44_2"></TD></TR></TABLE>',
      ...
      for(
        myInnerHtml("EN40_2",'<input type="checkbox" name="A3_Skill40" onClick="A4(1)">',0),
        ...
        A3_Skill40.checked=n_A_Buf3[40],
        A3_Skill41.value=n_A_Buf3[41],
        A3_Skill42.value=n_A_Buf3[42],
        A3_Skill43.value=n_A_Buf3[43],
        A3_Skill44.value=n_A_Buf3[44]
    }else{
      var str;
      str='<table class="tborder">',
      str+='<TR><TD id="A4TD" class="subheader point" onclick="Buf4SW(1)">Guild Skills <span id="A4used"></span>',
      str+='<div class="right">(click to show)</div></TD></TR></TABLE>',
      myInnerHtml("SP_SIEN02",str,0)
    }
    A4(0)
...
function A4(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("A4TD").style.backgroundColor=sBGC[i],
    myInnerHtml("A4used","",0)
  ):(
    document.getElementById("A4TD").style.backgroundColor=saBGC[i],
...
function A6(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("A6TD").style.backgroundColor=sBGC[i],
    myInnerHtml("A6used","",0)
  ):(
    document.getElementById("A6TD").style.backgroundColor=saBGC[i],
...
function Buf7SW(v){
  with(document.calcForm){
    if(n_Skill7SW=v,n_Skill7SW){
      ...
      for(
        str='<table class="tborder">',
        str+='<TR><TD id="A7TD" ColSpan="3" class="subheader point" onclick="Buf7SW(0)">Food / Speed Potions / other Items <span id="A7used"></span>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+='<TR><TD colspan="3" class="data dotB"><span id="EN73"></span><span id="EN74"></span><span id="EN75"></span><span id="EN76"></span><span id="EN77"></span><span id="EN78"></span></TD></TR>',
        str+='<TR><TD id="EN722" class="data"></TD><TD class="data"><Font size="2"><B>Battle Grounds Food</B></Font></TD><TD><Font size="2"><B>Elemental Resist Potions</B></Font></TD></TR>',
        str+='<TR><TD id="EN717" class="data"></TD><TD id="EN723" class="data"></TD><TD id="EN711"></TD></TR>',
        str+='<TR><TD id="EN720" class="data"></TD><TD id="EN724" class="data"></TD><TD id="EN712"></TD></TR>',
        str+='<TR><TD id="EN710" class="data"></TD><TD id="EN725" class="data"></TD><TD id="EN713"></TD></TR>',
        str+='<TR><TD id="EN79" class="data"></TD><TD id="EN726" class="dotB data"></TD><TD id="EN714" class="dotB"></TD></TR>',
        str+='<TR><TD id="EN70" class="data"></TD><TD colspan="2"><Font size="2"><B>New World Food</B></Font></TD></TR>',
        str+='<TR><TD id="EN71" class="data"></TD><TD colspan="2" id="EN727"></TD></TR>',
        str+='<TR><TD id="EN72" class="data"></TD><TD colspan="2" id="EN728"></TD></TR>',
        str+='<TR><TD id="EN715" class="data"></TD><TD colspan="2" id="EN729"></TD></TR>',
        str+='<TR><TD id="EN716" class="data"></TD><TD colspan="2" id="EN730"></TD></TR>',
        str+='<TR><TD id="EN718" class="data"></TD><TD colspan="2" id="EN731"></TD></TR>',
        str+='<TR><TD id="EN719" class="data"></TD><TD colspan="2" id="EN732"></TD></TR>',
        str+='<TR><TD id="EN721" class="data"></TD><TD colspan="2" id="EN733"></TD></TR>',
        str+='<TR><TD id="EN743" class="data"></TD><TD colspan="2" id="EN734"></TD></TR>',
        str+='<TR><TD id="EN738" class="data"></TD><TD colspan="2" id="EN735" class="dotB"></TD></TR>',
        str+='<TR><TD id="EN737" class="data"></TD><TD colspan="2"><Font size="2"><B>Stat+20 Food</B></Font></TD></TR>',
        str+='<TR><TD id="EN742" class="data"></TD><TD colspan="2" id="EN741"></TD></TR>',
        str+='<TR><TD id="EN746" class="data"></TD><TD colspan="2" id="EN747"></TD></TR>',
        str+='<TR><TD id="EN744" class="data"></TD><TD colspan="2" id="EN748"></TD></TR>',
        str+='<TR><TD id="EN745" class="data"></TD><TD colspan="2" id="EN749"></TD></TR>',
        str+='<TR><TD id="EN739" class="data"></TD><TD colspan="2" id="EN750"></TD></TR>',
        str+='<TR><TD id="EN740" class="data"></TD><TD colspan="2" id="EN751"></TD></TR>',
        str+="</TABLE>",
        ...
        myInnerHtml("EN715",'<input type="checkbox" name="A7_Skill26" onClick="A7(1)">Guarana Candy [ASPD +10%, HIT +5]',0),
      ...
      A7_Skill39.options[0]=new Option("(No HP Increase Potion)",0),
      A7_Skill39.options[1]=new Option("Small HP Increase Potion",1),
      A7_Skill39.options[2]=new Option("Medium HP Increase Potion",2),
      A7_Skill39.options[3]=new Option("Large HP Increase Potion",3),
      A7_Skill40.options[0]=new Option("(No SP Increase Potion)",0),
      A7_Skill40.options[1]=new Option("Small SP Increase Potion",1),
      A7_Skill40.options[2]=new Option("Medium SP Increase Potion",2),
      A7_Skill40.options[3]=new Option("Large SP Increase Potion",3),
      A7_Skill42.options[0]=new Option("(No Mega Resist Potion)",0),
      A7_Skill42.options[1]=new Option("Mega Resist Potion [+10% resistance to Blind,Bleeding,Confusion,Curse,Frozen,Poison,Silence,Sleep,Stun and Stone Curse status effects]",1),
      A7_Skill42.options[2]=new Option("Mega Resist Potion (iRO) [+20% resistance to Blind,Bleeding,Confusion,Curse,Frozen,Poison,Silence,Sleep,Stun and Stone Curse status effects]",2),
      SpeedPotName=["(No Speed Potion)","Concentration Potion","Awakening Potion (Lv40)","Berserk Potion"],
      A_SpeedPOT.options[0]=new Option(SpeedPotName[0],0),
      A_SpeedPOT.options[1]=new Option(SpeedPotName[1],1);
      A_SpeedPOT.options[3]=null; A_SpeedPOT.options[2]=null;
      3!=n_A_JOB&&9!=n_A_JobClass2()&&16!=n_A_JobClass2()?
        A_SpeedPOT.options[2]=new Option(SpeedPotName[2],2):
        A_SpeedPOT.options[2]=new Option("-",0),
      ...
      22==n_A_JOB?
        A_SpeedPOT.options[3]=new Option("* Special ("+SkillOBJ[304][2]+" Lv85) / Poison Bottle",3):
        A_SpeedPOT.options[3]=new Option("* Special ("+SkillOBJ[304][2]+") (Lv85)",3),
      A7_Skill0.checked=n_A_Buf7[0],
      A7_Skill1.checked=n_A_Buf7[1],
      A7_Skill2.checked=n_A_Buf7[2],
      A7_Skill3.value=n_A_Buf7[3],
      A7_Skill4.value=n_A_Buf7[4],
      A7_Skill5.value=n_A_Buf7[5],
      A7_Skill6.value=n_A_Buf7[6],
      A7_Skill7.value=n_A_Buf7[7],
      A7_Skill8.value=n_A_Buf7[8],
      A7_Skill9.checked=n_A_Buf7[9],
      A7_Skill10.checked=n_A_Buf7[10],
      A7_Skill11.checked=n_A_Buf7[11],
      A7_Skill12.checked=n_A_Buf7[12],
      A7_Skill13.checked=n_A_Buf7[13],
      A7_Skill14.checked=n_A_Buf7[14],
      A7_Skill16.checked=n_A_Buf7[16],
      A7_Skill17.checked=n_A_Buf7[17],
      A7_Skill18.checked=n_A_Buf7[18],
      A7_Skill19.checked=n_A_Buf7[19],
      A7_Skill20.checked=n_A_Buf7[20],
      A7_Skill21.checked=n_A_Buf7[21],
      A7_Skill22.checked=n_A_Buf7[22],
      A7_Skill23.checked=n_A_Buf7[23],
      A7_Skill24.checked=n_A_Buf7[24],
      A7_Skill25.checked=n_A_Buf7[25],
      A7_Skill26.checked=n_A_Buf7[26],
      A7_Skill27.checked=n_A_Buf7[27],
      A7_Skill28.checked=n_A_Buf7[28],
      A7_Skill29.checked=n_A_Buf7[29],
      A7_Skill30.checked=n_A_Buf7[30],
      A7_Skill31.checked=n_A_Buf7[31],
      A7_Skill32.checked=n_A_Buf7[32],
      A7_Skill33.checked=n_A_Buf7[33],
      A7_Skill34.checked=n_A_Buf7[34],
      A_SpeedPOT.value=n_A_Buf7[35],
      A7_Skill36.checked=n_A_Buf7[36],
      A7_Skill37.checked=n_A_Buf7[37],
      A7_Skill38.checked=n_A_Buf7[38],
      A7_Skill39.value=n_A_Buf7[39],
      A7_Skill40.value=n_A_Buf7[40],
      A7_Skill41.checked=n_A_Buf7[41],
      A7_Skill42.value=n_A_Buf7[42],
      A7_Skill43.checked=n_A_Buf7[43],
      A7_Skill44.checked=n_A_Buf7[44],
      A7_Skill45.checked=n_A_Buf7[45],
      A7_Skill46.checked=n_A_Buf7[46],
      A7_Skill47.checked=n_A_Buf7[47],
      A7_Skill48.checked=n_A_Buf7[48],
      A7_Skill49.checked=n_A_Buf7[49],
      A7_Skill50.checked=n_A_Buf7[50],
      A7_Skill51.checked=n_A_Buf7[51]
    }else{
      var str;
      str='<table class="tborder">',
      str+='<TR><TD id="A7TD" class="subheader point" onclick="Buf7SW(1)">Food / Speed Potions / other Items <span id="A7used"></span>',
      str+='<div class="right">(click to show)</div></TD></TR></TABLE>',
      myInnerHtml("SP_SIEN05",str,0)
    }
    A7(0)
...
function A7(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("A7TD").style.backgroundColor = sBGC[i],
    myInnerHtml("A7used","",0)
  ):(
    document.getElementById("A7TD").style.backgroundColor = saBGC[i],
...
function Buf8SW(v){
  with(document.calcForm){
    if(n_Skill8SW=v,n_Skill8SW){
      ...
      for(
        str='<table class="tborder">',
        str+='<TR><TD id="A8TD" class="subheader point" onclick="Buf8SW(0)">Additional Effects <SPAN id="A8used"></SPAN>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+='<TR><TD><Font size="2"><B>Pets</B></Font></TD></TR>',
        str+='<TR><TD id="EN800" class="dotB"></TD></TR>',
        str+='<TR><TD id="EN809" class="dotB"></TD></TR>',
        str+='<TR><TD><Font size="2"><B>EXP Items & Variables</B></Font></TD></TR>',
        str+='<TR><TD id="EN803" class="data"></TD></TR>',
        str+='<TR><TD id="EN804" class="data"></TD></TR>',
        str+='<TR><TD id="EN805" class="data"></TD></TR>',
        str+='<TR><TD id="EN806" class="data"></TD></TR>',
        str+='<TR><TD id="EN801" class="data"></TD></TR>',
        str+='<TR><TD id="EN802" class="data"></TD></TR>',
        str+="</TABLE>",
        myInnerHtml("ID_ETC",str,0),
        myInnerHtml("EN800",'<select name="A8_Skill0" onChange="A8(1)"></select>',0),
        i=0;i<PET_OBJ_SORT.length;i++
      ){
        var n=PET_OBJ_SORT[i];
        A8_Skill0.options[i]=new Option(PET_OBJ[n][1],PET_OBJ[n][0])
      }
      for(
        myInnerHtml("EN801",'Battle Manual <select name="A8_Skill1" onChange="A8(1)"></select>',0),
      ...
      for(
        myInnerHtml("EN804",'Server Job Experience Rate <select name="A8_Skill7" onChange="A8(1)"></select>',0),
        A8_Skill7.options[0]=new Option("1x",0),
        i=1;199>=i;i++
      ) A8_Skill7.options[i]=new Option(1+1*i+"x",i);
      for(
        myInnerHtml("EN805",'Partymember Count <select name="A8_Skill5" onChange="A8(1)"></select>',0),
        i=0;12>=i;i++
      ) A8_Skill5.options[i]=new Option(i, i);
      for(
        myInnerHtml("EN806",'Exp Tap Bonus <select name="A8_Skill6" onChange="A8(1)"></select>',0),
        A8_Skill6.options[0]=new Option("-",0),
        i=1;20>=i;i++
      ) A8_Skill6.options[i]=new Option("+"+25*i+"%",i);
      for(
        str='<Font size="2"><b>Temporary Card/Item active Effects </b></Font>',
        str+='<font color="red">(Duration and Chance are ignored)</font><BR>',
        str+='<select name="A8_Skill8" onChange="A8(1)"></select><BR>',
        str+='<select name="A8_Skill9" onChange="A8(1)"></select><BR>',
        str+='<select name="A8_Skill10" onChange="A8(1)"></select><BR>',
        str+='<select name="A8_Skill11" onChange="A8(1)"></select><BR>',
        myInnerHtml("EN809",str,0),
        i=0;i<ITEM_SP_TIME_OBJ_SORT.length;i++
      ){
      ...
      A8_Skill0.value=n_A_Buf8[0],
      A8_Skill1.value=n_A_Buf8[1],
      A8_Skill2.checked=n_A_Buf8[2],
      A8_Skill3.value=n_A_Buf8[3],
      A8_Skill5.value=n_A_Buf8[5],
      A8_Skill6.value=n_A_Buf8[6],
      A8_Skill7.value=n_A_Buf8[7],
      A8_Skill8.value=n_A_Buf8[8],
      A8_Skill9.value=n_A_Buf8[9],
      A8_Skill10.value=n_A_Buf8[10],
      A8_Skill11.value=n_A_Buf8[11]
    }else{
      var str;
      str='<table class="tborder">',
      str+='<TR><TD id="A8TD" class="subheader point" onclick="Buf8SW(1)">Additional Effects <SPAN id="A8used"></SPAN>',
      str+='<div class="right">(click to show)</div></TD></TR></TABLE>',
      myInnerHtml("ID_ETC",str,0)
    }
    A8(0)
...
function A8(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("A8TD").style.backgroundColor=sBGC[i],
    myInnerHtml("A8used","",0)
  ):(
    document.getElementById("A8TD").style.backgroundColor=saBGC[i],
...
function Buf9SW(v){
  with(document.calcForm){
    if(n_Skill9SW=v,n_Skill9SW){
      var str;
      for(
        str='<table class="tborder manual">',
        str+='<TR><TD id="A9TD" Colspan="4" class="subheader point" onclick="Buf9SW(0)">Additional Enchants & Manual Edits on Player <SPAN id="A9used"></SPAN>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+='<TR><TD colspan="4"><p class="center"><b>-- Anything here will ONLY be saved via Full Save --</b></p></TD></TR>',
        str+='<TR><TD colspan="4"><Font size="2"><B>Player Stats:</B></Font></TD></TR>',
        str+='<tr><TD id="EN965"></TD><TD id="EN967"></TD><TD id="EN969"></TD><td></td></tr>',
        str+='<tr><TD id="EN971"></TD><TD id="EN973"></TD><TD id="EN975"></TD><td></td></tr>',
        str+='<tr><TD id="EN931"></TD><TD id="EN933"></TD><TD id="EN935"></TD><TD id="EN937"></TD></tr>',
        str+='<tr><TD id="EN939"></TD><TD id="EN941"></TD><TD id="EN943"></TD><TD id="EN945"></TD></tr>',
        str+='<tr><TD id="EN951"></TD><TD id="EN953"></TD><TD id="EN947"></TD><TD id="EN949"></TD></tr>',
        str+='<tr><TD id="EN955"></TD><TD id="EN957"></TD><TD id="EN959"></TD><TD id="EN961"></TD></tr>',
        str+='<tr class="dotB"><TD id="EN963"></TD><td></td><td></td><td></td></tr>',
        str+='<TR><TD colspan="4"><Font size="2"><B>+% ATK based Damage:</B></Font></TD></TR>',
        str+='<tr><TD id="EN900" class="data"></TD><TD id="EN904" class="data"></TD><TD id="EN908" class="data"></TD><TD id="EN911"></TD></tr>',
        str+='<tr><TD id="EN901" class="data"></TD><TD id="EN905" class="data"></TD><TD id="EN909" class="data"></TD><TD id="EN912"></TD></tr>',
        str+='<tr><TD id="EN902" class="data"></TD><TD id="EN906" class="data"></TD><TD id="EN910" class="data"></TD><TD id="EN913"></TD></tr>',
        str+='<tr class="dotB"><TD id="EN903" class="data"></TD><TD id="EN907" class="data"></TD><td class="data"></td><TD id="EN914" class="data"></TD></tr>',
        str+='<TR><TD id="EN915" colspan="2"></TD><TD id="EN916" colspan="2"></TD></TR>',
        str+="</table>",
        myInnerHtml("ID_ARG",str,0),
        i=0;10>i;i++
      ) myInnerHtml("EN90"+i,'+<input type="text" onkeyup="A9(1)" name="ARG_RC'+i+'" value="0" size="1" class="center">% vs<select name="A9_Skill'+i+'" onChange="A9(1)"></select>',0);
      ...
      for(i=0;i<SyuzokuOBJ2.length;i++)
        A9_Skill0.options[i]=new Option(SyuzokuOBJ2[i],i),
        A9_Skill1.options[i]=new Option(SyuzokuOBJ2[i],i),
        A9_Skill2.options[i]=new Option(SyuzokuOBJ2[i],i),
        A9_Skill3.options[i]=new Option(SyuzokuOBJ2[i],i);
      for(i=0;i<ZokuseiOBJ2.length;i++)
        A9_Skill4.options[i]=new Option(ZokuseiOBJ2[i],i),
        A9_Skill5.options[i]=new Option(ZokuseiOBJ2[i],i),
        A9_Skill6.options[i]=new Option(ZokuseiOBJ2[i],i),
        A9_Skill7.options[i]=new Option(ZokuseiOBJ2[i],i);
      for(i=0;i<SizeOBJ.length;i++)
        A9_Skill8.options[i]=new Option(SizeOBJ[i],i),
        A9_Skill9.options[i]=new Option(SizeOBJ[i],i),
        A9_Skill10.options[i]=new Option(SizeOBJ[i],i);
      for(i=0;i<SpecialTypeOBJ.length;i++)
        A9_Skill11.options[i]=new Option(SpecialTypeOBJ[i],i),
        A9_Skill12.options[i]=new Option(SpecialTypeOBJ[i],i),
        A9_Skill13.options[i]=new Option(SpecialTypeOBJ[i],i),
        A9_Skill14.options[i]=new Option(SpecialTypeOBJ[i],i);
      myInnerHtml("EN915",'<Font size="2"><B>+<input type="text" onkeyup="A9(1)" name="ARG_RC26" value="0" size="1" class="center">% ATK based damage on any target.</B></Font>', 0),
      myInnerHtml("EN916",'<Font size="2"><B>+<input type="text" onkeyup="A9(1)" name="ARG_RC39" value="0" size="1" class="center">% MATK based damage on any target.</B></Font>', 0),
      myInnerHtml("EN931",'+<input type="text" onkeyup="A9(1)" name="ARG_RC15" value="0" size="1" class="center">MaxHP',0),
      myInnerHtml("EN933",'+<input type="text" onkeyup="A9(1)" name="ARG_RC16" value="0" size="1" class="center">% MaxHP',0),
      myInnerHtml("EN935",'+<input type="text" onkeyup="A9(1)" name="ARG_RC17" value="0" size="1" class="center">MaxSP',0),
      myInnerHtml("EN937",'+<input type="text" onkeyup="A9(1)" name="ARG_RC18" value="0" size="1" class="center">% MaxSP',0),
      myInnerHtml("EN939",'+<input type="text" onkeyup="A9(1)" name="ARG_RC19" value="0" size="1" class="center">DEF',0),
      myInnerHtml("EN941",'+<input type="text" onkeyup="A9(1)" name="ARG_RC20" value="0" size="1" class="center">MDEF',0),
      myInnerHtml("EN943",'+<input type="text" onkeyup="A9(1)" name="ARG_RC21" value="0" size="1" class="center">HIT',0),
      myInnerHtml("EN945",'+<input type="text" onkeyup="A9(1)" name="ARG_RC22" value="0" size="1" class="center">FLEE',0),
      myInnerHtml("EN947",'+<input type="text" onkeyup="A9(1)" name="ARG_RC23" value="0" size="1" class="center">Perfect Dodge',0),
      myInnerHtml("EN949",'+<input type="text" onkeyup="A9(1)" name="ARG_RC24" value="0" size="1" class="center">Critical Rate',0),
      myInnerHtml("EN951",'+<input type="text" onkeyup="A9(1)" name="ARG_RC25" value="0" size="1" class="center">ATK',0),
      myInnerHtml("EN953",'+<input type="text" onkeyup="A9(1)" name="ARG_RC38" value="0" size="1" class="center">% ATK',0),
      myInnerHtml("EN955",'+<input type="text" onkeyup="A9(1)" name="ARG_RC27" value="0" size="1" class="center">MATK',0),
      myInnerHtml("EN957",'+<input type="text" onkeyup="A9(1)" name="ARG_RC28" value="0" size="1" class="center">% MATK',0),
      myInnerHtml("EN959",'+<input type="text" onkeyup="A9(1)" name="ARG_RC29" value="0" size="1" class="center">% ASPD',0),
      myInnerHtml("EN961",'+<input type="text" onkeyup="A9(1)" name="ARG_RC30" value="0" size="1" class="center">% HP Regen',0),
      myInnerHtml("EN963",'+<input type="text" onkeyup="A9(1)" name="ARG_RC31" value="0" size="1" class="center">% SP Regen',0),
      myInnerHtml("EN965",'+<input type="text" onkeyup="A9(1)" name="ARG_RC32" value="0" size="1" class="center">STR',0),
      myInnerHtml("EN967",'+<input type="text" onkeyup="A9(1)" name="ARG_RC33" value="0" size="1" class="center">AGI',0),
      myInnerHtml("EN969",'+<input type="text" onkeyup="A9(1)" name="ARG_RC34" value="0" size="1" class="center">VIT',0),
      myInnerHtml("EN971",'+<input type="text" onkeyup="A9(1)" name="ARG_RC35" value="0" size="1" class="center">INT',0),
      myInnerHtml("EN973",'+<input type="text" onkeyup="A9(1)" name="ARG_RC36" value="0" size="1" class="center">DEX',0),
      myInnerHtml("EN975",'+<input type="text" onkeyup="A9(1)" name="ARG_RC37" value="0" size="1" class="center">LUK',0),
      A9_Skill0.value=n_A_Buf9[0],
      ARG_RC0.value=n_A_Buf9[1],
      A9_Skill1.value=n_A_Buf9[2],
      ARG_RC1.value=n_A_Buf9[3],
      A9_Skill2.value=n_A_Buf9[4],
      ARG_RC2.value=n_A_Buf9[5],
      A9_Skill3.value=n_A_Buf9[6],
      ARG_RC3.value=n_A_Buf9[7],
      A9_Skill4.value=n_A_Buf9[8],
      ARG_RC4.value=n_A_Buf9[9],
      A9_Skill5.value=n_A_Buf9[10],
      ARG_RC5.value=n_A_Buf9[11],
      A9_Skill6.value=n_A_Buf9[12],
      ARG_RC6.value=n_A_Buf9[13],
      A9_Skill7.value=n_A_Buf9[14],
      ARG_RC7.value=n_A_Buf9[15],
      A9_Skill8.value=n_A_Buf9[16],
      ARG_RC8.value=n_A_Buf9[17],
      A9_Skill9.value=n_A_Buf9[18],
      ARG_RC9.value=n_A_Buf9[19],
      A9_Skill10.value=n_A_Buf9[20],
      ARG_RC10.value=n_A_Buf9[21],
      A9_Skill11.value=n_A_Buf9[22],
      ARG_RC11.value=n_A_Buf9[23],
      A9_Skill12.value=n_A_Buf9[24],
      ARG_RC12.value=n_A_Buf9[25],
      A9_Skill13.value=n_A_Buf9[26],
      ARG_RC13.value=n_A_Buf9[27],
      A9_Skill14.value=n_A_Buf9[28],
      ARG_RC14.value=n_A_Buf9[29],
      ARG_RC15.value=n_A_Buf9[30],
      ARG_RC16.value=n_A_Buf9[31],
      ARG_RC17.value=n_A_Buf9[32],
      ARG_RC18.value=n_A_Buf9[33],
      ARG_RC19.value=n_A_Buf9[34],
      ARG_RC20.value=n_A_Buf9[35],
      ARG_RC21.value=n_A_Buf9[36],
      ARG_RC22.value=n_A_Buf9[37],
      ARG_RC23.value=n_A_Buf9[38],
      ARG_RC24.value=n_A_Buf9[39],
      ARG_RC25.value=n_A_Buf9[40],
      ARG_RC26.value=n_A_Buf9[41],
      ARG_RC27.value=n_A_Buf9[42],
      ARG_RC28.value=n_A_Buf9[43],
      ARG_RC29.value=n_A_Buf9[44],
      ARG_RC30.value=n_A_Buf9[45],
      ARG_RC31.value=n_A_Buf9[46],
      ARG_RC32.value=n_A_Buf9[47],
      ARG_RC33.value=n_A_Buf9[48],
      ARG_RC34.value=n_A_Buf9[49],
      ARG_RC35.value=n_A_Buf9[50],
      ARG_RC36.value=n_A_Buf9[51],
      ARG_RC37.value=n_A_Buf9[52],
      ARG_RC38.value=n_A_Buf9[53],
      ARG_RC39.value=n_A_Buf9[54]
    }else{
      var str;
      str='<table class="tborder">',
      str+='<TR><TD id="A9TD" class="subheader point" onclick="Buf9SW(1)">Additional Enchants & Manual Edits on Player <SPAN id="A9used"></SPAN>',
      str+='<div class="right">(click to show)</div></TD></TR></TABLE>',
      myInnerHtml("ID_ARG",str,0)
    }
    A9(0)
...
function A9(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("A9TD").style.backgroundColor=sBGC[i],
    myInnerHtml("A9used","",0)
  ):(
    document.getElementById("A9TD").style.backgroundColor=saBGC[i],
...
function Buf10SW(v){
  with(document.calcForm){
    if(n_Skill10SW=v,n_Skill10SW){
      var str;
      for(
        str='<table class="tborderA manual">',
        str+='<TR><TD id="A10TD" Colspan="4" class="subheader point" onclick="Buf10SW(0)">Manual Edits on Enemy <SPAN id="A10used"></SPAN>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+="<TR><TD colspan='4'><Font size='2'><B>Enemy's Stats:</B></Font></TD></TR>",
        str+='<tr><TD id="EN1065"></TD><TD id="EN1067"></TD><TD id="EN1069"></TD><td></td></tr>',
        str+='<tr><TD id="EN1071"></TD><TD id="EN1073"></TD><TD id="EN1075"></TD><td></td></tr>',
        str+='<tr><TD id="EN1031"></TD><TD id="EN1033"></TD><TD id="EN1035"></TD><TD id="EN1037"></TD></tr>',
        str+='<tr><TD id="EN1039"></TD><TD id="EN1041"></TD><TD id="EN1043"></TD><TD id="EN1045"></TD></tr>',
        str+='<tr><TD id="EN1051"></TD><TD id="EN1053"></TD><TD id="EN1047"></TD><TD id="EN1049"></TD></tr>',
        str+='<tr><TD id="EN1055"></TD><TD id="EN1057"></TD><TD id="EN1059"></TD><TD id="EN1061"></TD></tr>',
        str+='<tr class="dotB"><TD id="EN1063"></TD><td></td><td></td><td></td></tr>',
        str+="<TR><TD colspan='4'><Font size='2'><B>Enemy's Damage Reductions:</B></Font></TD></TR>",
        str+='<tr><TD id="EN1001"></TD><TD id="EN1000"></TD><TD id="EN1004"></TD><TD id="EN1011"></TD></tr>',
        str+='<tr><TD id="EN1002"></TD><TD id="EN1003"></TD><TD id="EN1010"></TD><TD id="EN1012"></TD></tr>',
        str+='<tr><TD id="EN1008"></TD><TD id="EN1006"></TD><TD id="EN1009"></TD><TD id="EN1013"></TD></tr>',
        str+='<tr class="dotB"><TD id="EN1005"></TD><TD id="EN1007"></TD><td></td><TD id="EN1014"></TD></tr>',
        str+='<TR class="dotB"><TD id="EN1015" colspan="2"></TD><TD id="EN1016" colspan="2"></TD></TR>',
        str+="</table>",
        myInnerHtml("B_MANUAL",str,0),
        myInnerHtml("EN1000",'+<input type="text" onkeyup="A10(1)" name="BRG_RC0" value="0" size="1" class="center">% Racial Resistance',0),
        myInnerHtml("EN1001",'+<input type="text" onkeyup="A10(1)" name="BRG_RC1" value="0" size="1" class="center">vs<select name="Bman1" onChange="A10(1)"></select>',0),
        myInnerHtml("EN1002",'+<input type="text" onkeyup="A10(1)" name="BRG_RC2" value="0" size="1" class="center">vs<select name="Bman2" onChange="A10(1)"></select>',0),
        myInnerHtml("EN1003",'+<input type="text" onkeyup="A10(1)" name="BRG_RC3" value="0" size="1" class="center">% Size Resistance',0),
        myInnerHtml("EN1004",'+<input type="text" onkeyup="A10(1)" name="BRG_RC4" value="0" size="1" class="center">% Long-range Resistance',0),
        myInnerHtml("EN1010",'+<input type="text" onkeyup="A10(1)" name="BRG_RC10" value="0" size="1" class="center">% Additional Reflect (Equip/Card)',0),
        myInnerHtml("EN1011","",0),
        myInnerHtml("EN1012","",0),
        myInnerHtml("EN1013","",0),
        myInnerHtml("EN1014","",0),
        i=0;9>=i;i++
      ) Bman1.options[i]=new Option(ZokuseiOBJ2[i],i),Bman2.options[i]=new Option(ZokuseiOBJ2[i],i);
      for(
        myInnerHtml("EN1015",'<Font size="2"><B>+<input type="text" onkeyup="A10(1)" name="BRG_RC26" value="0" size="1" class="center">% ATK based damage on any target.</B></Font>',0),
        myInnerHtml("EN1016",'<Font size="2"><B>+<input type="text" onkeyup="A10(1)" name="BRG_RC39" value="0" size="1" class="center">% MATK based damage on any target.</B></Font>',0),
        myInnerHtml("EN1031",'+<input type="text" onkeyup="A10(1)" name="BRG_RC15" value="0" size="1" class="center">MaxHP',0),
        myInnerHtml("EN1033",'+<input type="text" onkeyup="A10(1)" name="BRG_RC16" value="0" size="1" class="center">% MaxHP',0),
        myInnerHtml("EN1039",'+<input type="text" onkeyup="A10(1)" name="BRG_RC19" value="0" size="1" class="center">DEF',0),
        myInnerHtml("EN1041",'+<input type="text" onkeyup="A10(1)" name="BRG_RC20" value="0" size="1" class="center">MDEF',0),
        myInnerHtml("EN1043",'+<input type="text" onkeyup="A10(1)" name="BRG_RC21" value="0" size="1" class="center">HIT',0),
        myInnerHtml("EN1045",'+<input type="text" onkeyup="A10(1)" name="BRG_RC22" value="0" size="1" class="center">FLEE',0),
        myInnerHtml("EN1047",'+<input type="text" onkeyup="A10(1)" name="BRG_RC23" value="0" size="1" class="center" disabled><S>Perfect Dodge</S>',0),
        myInnerHtml("EN1049",'+<input type="text" onkeyup="A10(1)" name="BRG_RC24" value="0" size="1" class="center">Critical Rate',0),
        myInnerHtml("EN1051",'+<input type="text" onkeyup="A10(1)" name="BRG_RC25" value="0" size="1" class="center">ATK',0),
        myInnerHtml("EN1053",'+<input type="text" onkeyup="A10(1)" name="BRG_RC38" value="0" size="1" class="center">% ATK',0),
        myInnerHtml("EN1055",'+<input type="text" onkeyup="A10(1)" name="BRG_RC27" value="0" size="1" class="center">MATK',0),
        myInnerHtml("EN1057",'+<input type="text" onkeyup="A10(1)" name="BRG_RC28" value="0" size="1" class="center">% MATK',0),
        myInnerHtml("EN1059",'+<input type="text" onkeyup="A10(1)" name="BRG_RC29" value="0" size="1" class="center" disabled><S>% ASPD</S>',0),
        myInnerHtml("EN1061","",0),
        myInnerHtml("EN1063","",0),
        myInnerHtml("EN1065","",0),
        myInnerHtml("EN1067",'AGI +<select name="BRG_RC33" onChange="A10(1)"></select>',0),
        myInnerHtml("EN1069",'VIT +<select name="BRG_RC34" onChange="A10(1)"></select>',0),
        myInnerHtml("EN1071",'INT +<select name="BRG_RC35" onChange="A10(1)"></select>',0),
        myInnerHtml("EN1073",'DEX +<select name="BRG_RC36" onChange="A10(1)"></select>',0),
        myInnerHtml("EN1075",'LUK +<select name="BRG_RC37" onChange="A10(1)"></select>',0),
        i=0;200>=i;i++
      ) BRG_RC33.options[i]=new Option(i,i),
        BRG_RC34.options[i]=new Option(i,i),
        BRG_RC35.options[i]=new Option(i,i),
        BRG_RC36.options[i]=new Option(i,i),
        BRG_RC37.options[i]=new Option(i,i);
      BRG_RC0.value=n_B_manual[1],
      Bman1.value=n_B_manual[2],
      BRG_RC1.value=n_B_manual[3],
      Bman2.value=n_B_manual[4],
      BRG_RC2.value=n_B_manual[5],
      BRG_RC3.value=n_B_manual[7],
      BRG_RC4.value=n_B_manual[9],
      BRG_RC10.value=n_B_manual[21],
      BRG_RC15.value=n_B_manual[30],
      BRG_RC16.value=n_B_manual[31],
      BRG_RC19.value=n_B_manual[34],
      BRG_RC20.value=n_B_manual[35],
      BRG_RC21.value=n_B_manual[36],
      BRG_RC22.value=n_B_manual[37],
      BRG_RC23.value=n_B_manual[38],
      BRG_RC24.value=n_B_manual[39],
      BRG_RC25.value=n_B_manual[40],
      BRG_RC26.value=n_B_manual[41],
      BRG_RC27.value=n_B_manual[42],
      BRG_RC28.value=n_B_manual[43],
      BRG_RC29.value=n_B_manual[44],
      BRG_RC33.value=n_B_manual[48],
      BRG_RC34.value=n_B_manual[49],
      BRG_RC35.value=n_B_manual[50],
      BRG_RC36.value=n_B_manual[51],
      BRG_RC37.value=n_B_manual[52],
      BRG_RC38.value=n_B_manual[53],
      BRG_RC39.value=n_B_manual[54]
    }else{
      var str;
      str='<table class="tborderA">',
      str+='<TR><TD id="A10TD" class="subheader point" onclick="Buf10SW(1)">Manual Edits on Enemy <SPAN id="A10used"></SPAN>',
      str+='<div class="right">(click to show)</div></TD></TR></TABLE>',
      myInnerHtml("B_MANUAL",str,0)
    }
    A10(0)
...
function A10(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("A10TD").style.backgroundColor=sBGC[i],
    myInnerHtml("A10used","",0)
  ):(
    document.getElementById("A10TD").style.backgroundColor=saBGC[i],
...
function IjyouSW(v){
  with(document.calcForm){
    if(n_IjyouSW=v,n_IjyouSW){
      ...
      if(
        str='<table class="tborder">',
        str+='<TR><TD id="AITD" ColSpan="4" class="subheader point" onClick="IjyouSW(0)">Debuffs on Enemy <span id="AIused"></span>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+='<TR><TD id="BI0_1" class="center">Provoke (Non Undead)</TD><TD id="BI0_2" class="data"></TD><TD id="BI2_1" class="center">Poison</TD><TD id="BI2_2"></TD></TR>',
        str+='<TR><TD id="BI4_1" class="center">Frozen (Non Undead)</TD><TD id="BI4_2" class="data"></TD><TD id="BI3_1" class="center">Blind</TD><TD id="BI3_2"></TD></TR>',
        str+='<TR><TD id="BI5_1" class="center">Blessing (Demon/Undead)</TD><TD id="BI5_2" class="data"></TD><TD id="BI10_1" class="center">Curse</TD><TD id="BI10_2"></TD></TR>',
        str+='<TR><TD id="BI6_1" class="center">Lex Aeterna</TD><TD id="BI6_2" class="data"></TD><TD id="BI7_1" class="center">Stun</TD><TD id="BI7_2"></TD></TR>',
        str+='<TR><TD id="BI11_1" class="center">Agility Down</TD><TD id="BI11_2" class="data"></TD><TD id="BI9_1" class="center">Stone</TD><TD id="BI9_2"></TD></TR>',
        str+='<TR><TD id="BI1_1" class="center">Quagmire</TD><TD id="BI1_2" class="data"></TD><TD id="BI8_1" class="center">Sleep</TD><TD id="BI8_2"></TD></TR>',
        str+='<TR><TD id="BI12_1" class="center">Signum Crucis</TD><TD id="BI12_2" class="data"></TD><TD id="BI19_1" class="center">Slow Grace</TD><TD id="BI19_2"></TD></TR>',
        str+='<TR><TD id="BI24_1" class="center">Coin Fling</TD><TD id="BI24_2" class="data"></TD><TD id="BI20_1" class="center">Down Tempo</TD><TD id="BI20_2"></TD></TR>',
        str+='<TR class="dotB"><TD id="BI18_1" class="center">Mind Breaker</TD><TD id="BI18_2" class="data"></TD><TD id="BI17_1" class="center">Spider Web</TD><TD id="BI17_2"></TD></TR>',
        0==Taijin&&(
          str+='<TR><TD class="center" ColSpan="4"><b>Monster Exclusive Debuffs</b></TD></TR>',
          str+='<TR><TD id="BI13_1" class="center">Strip Weapon</TD><TD id="BI13_2" class="data"></TD><TD id="BI14_1" class="center">Strip Shield</TD><TD id="BI14_2"></TD></TR>',
          str+='<TR><TD id="BI15_1" class="center">Strip Armor</TD><TD id="BI15_2" class="data"></TD><TD id="BI16_1" class="center">Strip Helm</TD><TD id="BI16_2"></TD></TR>',
          str+='<TR><TD id="BI21_1" class="center">Eska</TD><TD id="BI21_2" class="data"></TD><TD id="BI22_1" class="center">Eske</TD><TD id="BI22_2"></TD></TR>',
          str+='<TR><TD id="BI23_1" class="center" colspan="2">Elemental Change (Sage Skill)</TD><TD id="BI23_2" colspan="2"></TD></TR>'
        ),
        str+="</TABLE>",
        ...
        myInnerHtml("BI23_2",'<select name="B_IJYOU23" onChange="AI(1)"></select>',0);
      ...
      var str;
      str='<table class="tborder">',
      str+='<TR><TD id="AITD" class="subheader point" onClick="IjyouSW(1)">Debuffs on Enemy <span id="AIused"></span>',
      str+='<div class="right">(click to show)</div></TD></TR></TABLE>',
      myInnerHtml("MONSTER_IJYOU",str,0)
    }
    AI(0)
...
function AI(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("AITD").style.backgroundColor=sBGC[i],
    myInnerHtml("AIused","",0)
  ):(
    document.getElementById("AITD").style.backgroundColor=saBGC[i],
...
function EnemyKyoukaSW(v){
  with(document.calcForm){
    if(n_KyoukaSW=v,n_KyoukaSW){
      ...
      for(
        str='<table class="tborder">',
        str+='<TR><TD id="AKTD" colspan="4" class="subheader point" onClick="EnemyKyoukaSW(0)">Buffs on Enemy <span id="AKused"></span>',
        str+='<div class="right">(click to hide)</div></TD></TR>',
        str+='<TR><TD class="center">Increase AGI</TD><TD id="ID_Kb0" class="data"></TD><TD class="center">Assumptio</TD><TD id="ID_Kb1"></TD></TR>',
        str+='<TR><TD class="center">Angelus</TD><TD id="ID_Kb10" class="data"></TD><TD class="center">Maximize Power</TD><TD id="ID_Kb3"></TD></TR>',
        str+='<TR><TD class="center">Auto Guard</TD><TD id="ID_Kb11" class="data"></TD><TD class="center">Adrenaline Rush</TD><TD id="ID_Kb2"></TD></TR>',
        str+='<TR><TD class="center">Shield Reflect</TD><TD id="ID_Kb12" class="data"></TD><TD class="center">Defending Aura</TD><TD id="ID_Kb13"></TD></TR>',
        str+='<TR><TD class="center dotB">Energy Coat</TD><TD id="ID_Kb14" class="data dotB" colspan="3"></TD></TR>',
        str+='<TR><TD class="center" colspan="4"><b>Monster Exclusive buffs</b></TD></TR>',
        str+='<TR><TD class="center">Attrib. Change</TD><TD id="ID_Kb6" class="data"></TD><TD class="center">Stone Skin</TD><TD id="ID_Kb7"></TD></TR>',
        str+='<TR><TD class="center">Keeping</TD><TD id="ID_Kb9" class="data"></TD><TD class="center">Magic Mirror</TD><TD id="ID_Kb8"></TD></TR>',
        str+='<TR><TD class="center"></TD><TD id="ID_Kb15" class="data"></TD><TD class="center">Agi Up (AGI x3)</TD><TD id="ID_Kb5"></TD></TR>',
        str+='<TR><TD class="center" colspan="2">POWER UP (ATK x3, HIT x2)</TD><TD id="ID_Kb4" colspan="2"></TD></TR>',
        str+="</TABLE>",
        ...
        myInnerHtml("ID_Kb6",'<select name="B_KYOUKA6" onChange="AK(1)"></select>',0),
        ...
        B_buff10.options[i]=new Option(i,i),
        B_buff11.options[i]=new Option(i,i),
        B_buff12.options[i]=new Option(i,i);
      for(i=0;5>=i;i++)
        B_KYOUKA5.options[i]=new Option(i,i),
        B_KYOUKA7.options[i]=new Option(i,i),
        B_KYOUKA8.options[i]=new Option(i,i),
        B_buff13.options[i]=new Option(i,i),
        B_buff14.options[i]=new Option(EnergyCoatOBJ[i],i);
      var ZoHe=[
        ["None",
      ...
      B_buff10.value=n_B_KYOUKA[10],
      B_buff11.value=n_B_KYOUKA[11],
      B_buff12.value=n_B_KYOUKA[12],
      B_buff13.value=n_B_KYOUKA[13],
      B_buff14.value=n_B_KYOUKA[14]
    }else{
      var str;
      str='<table class="tborder">',
      str+='<TR><TD id="AKTD" class="subheader point" onClick="EnemyKyoukaSW(1)">Buffs on Enemy <span id="AKused"></span>',
      str+='<div class="right">(click to show)</div></TD></TR></TABLE>',
      myInnerHtml("MONSTER_KYOUKA",str,0)
    }
    AK(0)
...
function AK(_){
  ...
  var i=document.getElementById("theme").value;
  0==n?(
    document.getElementById("AKTD").style.backgroundColor=sBGC[i],
    myInnerHtml("AKused","",0)
  ):(
    document.getElementById("AKTD").style.backgroundColor=saBGC[i],
...
function ClickB_Enemy(){
  with(document.calcForm){
    ...
    n_KyoukaSW&&(
      ...
      n_B_KYOUKA[10]=eval(B_buff10.value),
      n_B_KYOUKA[11]=eval(B_buff11.value),
      n_B_KYOUKA[12]=eval(B_buff12.value),
      n_B_KYOUKA[13]=eval(B_buff13.value),
      n_B_KYOUKA[14]=eval(B_buff14.value)
    ),
    ...
    if(
      ...
      var w,w2;
      Taijin?
        (w2=5*n_B_IJYOU[1],w=Math.floor(n_B[8]/4)):
        (w2=10*n_B_IJYOU[1],w=Math.floor(n_B[8]/2)),
    ...
    if(
      ...
      var w,w2;
      Taijin?
      (w2=5*n_B_IJYOU[1],w=Math.floor(n_B[10]/4)):
    ...
    w=n_B_KYOUKA[10],
    w&&(
      n_B[23]=Math.floor(n_B[23]*(1+.05*w)),
      n_B[24]=Math.floor(n_B[24]*(1+.05*w))
    ),
    ...
    0==Taijin&&n_B_KYOUKA[8]&&(
      n_B[23]-=Math.floor(20*n_B[23]*n_B_KYOUKA[8]/100),
      n_B[24]-=Math.floor(20*n_B[24]*n_B_KYOUKA[8]/100)
    ),
    0==Taijin&&n_B_IJYOU[21]&&(n_B[24]+=90),
    n_B_IJYOU[20]&&(
      n_B[23]=0,
      n_B[24]=0
    );
    ...
    if(
      ...
      var w2_Exp=0;
      EquipNumSearch(1030)&&(w1_Exp+=5*EquipNumSearch(1030)),
      3!=n_A_JobClass()||!CardNumSearch(452)||1!=n_B[2]&&6!=n_B[2]||(w1_Exp+=5),
      2==n_B[2]&&4==n_A_JobClass()&&CardNumSearch(453)&&(w1_Exp+=5),
      n_A_Buf8[1]&&(w1_Exp+=25*n_A_Buf8[1]),
      n_A_Buf8[2]&&(w2_Exp+=50),
      n_A_Buf6[2]&&(w1_Exp+=100),
      (3==document.calcForm.A8_Skill14.value||n_A_Buf6[2])&&(w1_Exp=2*w1_Exp,w2_Exp=2*w2_Exp),
      (0!=w1_Exp||0!=w2_Exp)&&(
        n_B[16]=Math.floor(n_B[16]*w1_Exp/100),
        n_B[17]=Math.floor(n_B[17]*(w1_Exp+w2_Exp)/100)
      ),
      n_A_Buf8[5]&&(
        n_B[16]=Math.floor(n_B[16]/(1+n_A_Buf8[5])+1),
        n_B[17]=Math.floor(n_B[17]/(1+n_A_Buf8[5])+1)
      ),
      n_A_Buf8[6]&&(
        n_B[16]=Math.floor(n_B[16]*(100+25*n_A_Buf8[6])/100),
    ...
    for(i=0;8>=i;i++){
      ...
      n_B[wIJ[i]]<n_B2[wIJ[i]]&&(wIJstr=wFront+n_B[wIJ[i]]+wBack),
      n_B[wIJ[i]]>n_B2[wIJ[i]]&&(wIJstr=wFront2+n_B[wIJ[i]]+wBack),
      myInnerHtml("B_"+wIJ[i],wIJstr,0)
    }
    if(0==Taijin)
      for(i=0;1>=i;i++){
        var wIJstr=n_B[wIJ2[i]];
        n_B[wIJ2[i]]<n_B2[wIJ2[i]]&&(wIJstr=wFront2+n_B[wIJ2[i]]+wBack),
        n_B[wIJ2[i]]>n_B2[wIJ2[i]]&&(wIJstr=wFront+n_B[wIJ2[i]]+wBack),
...
function calc(){
  ...
  if(
    ...
    (32==cardOBJ[n_A_card[0]][0]||32==cardOBJ[n_A_card[1]][0]||32==cardOBJ[n_A_card[2]][0]||32==cardOBJ[n_A_card[3]][0]||
      32==cardOBJ[n_A_card[4]][0]||32==cardOBJ[n_A_card[5]][0]||32==cardOBJ[n_A_card[6]][0]||32==cardOBJ[n_A_card[7]][0])&&(wCSize=1),
    ...
    StPlusCalc2(86)+StPlusCard(86)&&(w_HIT+=(100-w_HIT)*(StPlusCalc2(86)+StPlusCard(86))/100),
    ...
    0!=n_A_WeaponType&&(
      (EquipNumSearch(570)||EquipNumSearch(1442)||EquipNumSearch(1443))&&(SkillSearch(13)>2?wDA=5*SkillSearch(13):wDA=10),
      EquipNumSearch(1578)&&(
        wDA=5*SkillSearch(13),
        (5==n_A_SHOULDER_DEF_PLUS||6==n_A_SHOULDER_DEF_PLUS)&&SkillSearch(13)<1&&(wDA=5),
        n_A_SHOULDER_DEF_PLUS>=7&&SkillSearch(13)<5&&(wDA=25)
      ),
    ...
    0==SRV&&(w_HIT>=100&&(w998K=100),w_Cri>=100&&(w998K=100)),
    w998L=100-w998K,
    (0==n_A_ActiveSkill||272==n_A_ActiveSkill||401==n_A_ActiveSkill||86==n_A_ActiveSkill&&50<=n_B[3]&&n_B[3]<60)&&(
      w_HIT_HYOUJI=Math.floor(100*w998K)/100,myInnerHtml("CRInum",Math.round(100*w998G)/100+SubName[0],0)
    ),
    w_FLEE=n_A_FLEE+20-n_B_HIT,
    w_FLEE>95?w_FLEE=95:w_FLEE<5&&(w_FLEE=5),
    (444==n_B_AtkSkill||445==n_B_AtkSkill||475==n_B_AtkSkill||476==n_B_AtkSkill||481==n_B_AtkSkill)&&(
      w_FLEE=0,n_A_LUCKY=0,n_A_Buf6[3]&&0!=n_B_rangedAtk&&(w_FLEE=75)
    ),
    n_A_Buf6[3]&&0!=n_B_rangedAtk&&(w_FLEE=75),
    0!=n_B_AtkSkill&&(n_A_LUCKY=0),
    myInnerHtml("BattleFLEE",Math.floor(100*(w_FLEE+(100-w_FLEE)*n_A_LUCKY/100))/100,0),
    ...
    (10==n_A_WeaponType||17==n_A_WeaponType||18==n_A_WeaponType||19==n_A_WeaponType||20==n_A_WeaponType||21==n_A_WeaponType)&&(
      ...
      l=Math.floor((ArrowOBJ[n_A_Arrow][0]-1)*wCSize),
      w1+=l,
      t+=l,
      w1>t&&(w1=t),
    ...
    10==n_A_WeaponType||17==n_A_WeaponType||18==n_A_WeaponType||19==n_A_WeaponType||20==n_A_WeaponType||21==n_A_WeaponType?(
      ...
      l=n_A_ATK+n_A_WeaponLV_Minplus+Math.floor((n_A_Weapon_ATK*n_A_workDEX/100+wImp)*wCSize),
      n_A_DMG[0]>l&&(n_A_DMG[0]=l)
    ):n_A_workDEX>=n_A_Weapon_ATK?
      n_A_DMG[0]=n_A_ATK+n_A_WeaponLV_Minplus+Math.floor((n_A_Weapon_ATK+wImp)*wCSize):
      (SkillSearch(155)&&(n_A_workDEX=n_A_Weapon_ATK),n_A_DMG[0]=n_A_ATK+n_A_WeaponLV_Minplus+Math.floor((n_A_workDEX+wImp)*wCSize)),
    ...
    (10==n_A_WeaponType||17==n_A_WeaponType||18==n_A_WeaponType||19==n_A_WeaponType||20== n_A_WeaponType||21==n_A_WeaponType)&&(n_Enekyori=1,10==n_A_WeaponType)
  ...
  if(11==n_A_WeaponType){
    ...
    n_A_CriATK[0]==n_A_CriATK[2]?
      myInnerHtml("CRIATK",n_A_CriATK[0]+" ("+(n_A_CriATK[0]-n[0])+" + "+n[0]+")",0):
      myInnerHtml("CRIATK",n_A_CriATK[0]+"~"+n_A_CriATK[2]+" ("+(n_A_CriATK[0]-n[0])+"~"+(n_A_CriATK[2]-n[2])+" + "+n[0]+"~"+n[2]+")",0)
  }else
    n_A_CriATK[0]==n_A_CriATK[2]?
  ...
  if(
    n_Max_DMG=0,
    n_Min_DMG=9999999,
    (0==n_A_ActiveSkill||86==n_A_ActiveSkill&&50<=n_B[3]&&n_B[3]<60)&&w998G>0&&(n_Min_DMG=n_A_CriATK[0],n_Max_DMG=n_A_CriATK[2]),
    BattleCalc999(),
    myInnerHtml("A_WeaponElement",ZokuseiOBJ[n_A_Weapon_zokusei]+" ("+100*zokusei[n_B[3]][n_A_Weapon_zokusei]+"% vs "+ZokuseiOBJ[Math.floor(n_B[3]/10)]+n_B[3]%10+")",0),
    0==n_Enekyori
  ){
    var e=n_B_KYOUKA[12],i=n_B_manual[21];
    if(e>0){
      e=10+3*e;
      var l,t=1;
      1==n_B_KYOUKA[1]&&(t=1.5);
      for(var _=0;2>=_;_++)
        l=Math.floor(Last_DMG_A[_]*t*e/100),
        0==l&&(l=1),
        InnStr[_]+="<BR><B style='color:red'>"+l+" (Reflected)</B>"
    }
    if(i){
      var l,t=1,a=1;
      1==n_B_KYOUKA[1]&&(t=1.5),
      1==n_Ses&&(a=0!=n_A_ActiveSkill?100/60:1.25);
      for(var _=0;2>=_;_++)
        l=Math.floor(Last_DMG_B[_]*t*a*i/100),
        0==l&&(l=1),
        InnStr[_]+="<BR><B style='color:red'>"+l+" (Reflected)</B>"
    }
  }
...
function BattleCalc(_,n){
  return 10==n?_+=n_A_WeaponLV_seirenATK:_=BattleCalc4(_,n,0),
    1>_&&(_=1),
    1==n_A_WeaponType||2==n_A_WeaponType?_+=4*SkillSearch(3):
    3==n_A_WeaponType?_+=4*SkillSearch(4):
    4==n_A_WeaponType||5==n_A_WeaponType?_+=0==SkillSearch(78)?4*SkillSearch(69):5*SkillSearch(69):
    8==n_A_WeaponType?_+=3*SkillSearch(89):
    11==n_A_WeaponType?_+=3*SkillSearch(81):
    14==n_A_WeaponType?_+=3*SkillSearch(198):
    15==n_A_WeaponType?_+=3*SkillSearch(206):
    12==n_A_WeaponType?_+=3*SkillSearch(224):
    6==n_A_WeaponType||7==n_A_WeaponType?_+=3*SkillSearch(241):
    (13==n_A_WeaponType||0==n_A_WeaponType)&&(_+=3*SkillSearch(183)),
    0==n_A_WeaponType&&(_+=10*SkillSearch(329)),
    ...
    (2==n_B[2]||4==n_B[2])&&(_+=4*SkillSearch(116),SkillSearch(390)&&(_+=n_A_STR)),
    _=BattleCalc2(_),
    Math.floor(_)
}
function BattleCalc2(w999){
  if(
    ...
    0==wBCEDPch&&((17==n_A_ActiveSkill||307==n_A_ActiveSkill)&&(w999+=15*n_A_ActiveSkillLV),86==n_A_ActiveSkill&&(n_B[3]<50||60<=n_B[3])&&(w999+=75)),
    423==n_A_ActiveSkill&&(w999+=Math.floor(n_A_MATK[w_MagiclBulet]*(100-n_B[15])/100-n_B_MDEF2)),
    437==n_A_ActiveSkill&&(w999+=50*n_A_ActiveSkillLV),
    106==cardOBJ[n_A_card[0]][0]&&106==cardOBJ[n_A_card[1]][0]&&106==cardOBJ[n_A_card[2]][0]
  ) w999+=40;
  else for (i=0;2>=i;i++) 106==cardOBJ[n_A_card[i]][0]&&(w999+=5);
  return 106==n_A_card[3]&&(w999+=10),
    394==n_A_ActiveSkill&&(w999+=SyurikenOBJ[eval(document.calcForm.SkillSubNum.value)][0],w999+=3*SkillSearch(393),w999+=4*n_A_ActiveSkillLV),
    ...
    1==Taijin&&(317==n_A_ActiveSkill||318==n_A_ActiveSkill)&&(w999=0),
    w999
}
function BaiCI(_){
  if(0==wBCEDPch&&0==not_use_card){
    ...
    n=n_tok[40+Math.floor(n_B[3]/10)],
    _=Math.floor(_*(100+n)/100),
    n=n_tok[27+n_B[4]],
    _=Math.floor(_*(100+n)/100),
  ...
  return _=Math.floor(tPlusDamCut(_)),
    n=0,
    6==n_A_ActiveSkill&&n_A_SHOES_DEF_PLUS>=9&&CardNumSearch(362)&&(n+=10),
    76==n_A_ActiveSkill&&(2==n_A_WeaponType||3==n_A_WeaponType)&&(n+=25*CardNumSearch(464)),
    41==n_A_ActiveSkill&&10==n_A_WeaponType&&(n+=50*CardNumSearch(465)),
    40==n_A_ActiveSkill&&n_A_Weapon_ATKplus>=9&&EquipNumSearch(1089)&&(n+=20),
    428==n_A_ActiveSkill&&n_A_Weapon_ATKplus>=9&&EquipNumSearch(1099)&&(n+=2*n_A_Weapon_ATKplus),
    430==n_A_ActiveSkill&&n_A_Weapon_ATKplus>=9&&EquipNumSearch(1100)&&(n+=3*n_A_Weapon_ATKplus),
    436==n_A_ActiveSkill&&n_A_Weapon_ATKplus>=9&&EquipNumSearch(1102)&&(n+=2*n_A_Weapon_ATKplus),
    437==n_A_ActiveSkill&&n_A_Weapon_ATKplus>=9&&EquipNumSearch(1103)&&(n+=2*n_A_Weapon_ATKplus),
    (6==n_A_ActiveSkill||76==n_A_ActiveSkill)&&10==n_A_ActiveSkillLV&&EquipNumSearch(1159)&&(n+=50),
    (41==n_A_ActiveSkill)&&EquipNumSearch(1825)&&n_A_HEAD_DEF_PLUS>=9&&(n+=5*Math.floor(n_A_BaseLV/10)),
    65==n_A_ActiveSkill&&SU_LUK>=90&&SU_DEX>=90&&EquipNumSearch(1164)&&(n+=15),
...
function BattleCalc4(_,n,e){
  return e=0==e?n_A_WeaponLV_seirenATK:n_A_Weapon2LV_seirenATK,
    ...
    0==n?Math.floor(_*(n_B_DEF2[2]+n_B[14])/100)+e:
    1==n?Math.floor(_*(n_B_DEF2[1]+n_B[14])/100)+e:
    Math.floor(_*(n_B_DEF2[0]+n_B[14])/100)+e
}
function BattleCalcEDP(_,n){
  ...
  wBCEDPch=1;
  var e=0,i=0;
  return SkillSearch(266)&&(e=BattleCalc(_,n),e=Math.floor(e*zokusei[n_B[3]][5]/4)),
    n_A_Buf6[7]&&(i=BattleCalc(_,n),i=Math.floor(i*zokusei[n_B[3]][3]/5)),
    wBCEDPch=0,e+i
}
function EDPplus(_){
...
function EDP_DMG(_){
  if(SkillSearch(266)||n_A_Buf6[7]){
    ...
    if(1==_){
      var n=0;
      return 100==w_HIT_HYOUJI&&(n=1),n_PerHIT_DMG&&(n=1),
        Math.floor(n?n_A_EDP_DMG[1]*w_HIT_EDP/100:n_A_EDP_DMG[1]*w_HIT/100*w_HIT_EDP/100)
    }
...
function CastAndDelay(){
  ...
  var strSUB2name="",strSUB2="";
  wDelay=0;
  var w=0;
  n_Delay[1]>wDelay&&(wDelay=n_Delay[1],w=1),
  n_Delay[2]=Math.floor(n_Delay[2]*(100-AC_I-(100-AC_I)*n_tok[74]/100))/100,
  n_Delay[2]>wDelay&&(wDelay=n_Delay[2],w=2),
  n_Delay[3]>wDelay&&(wDelay=n_Delay[3],w=3),
  0!=n_A_ActiveSkill&&284!=n_A_ActiveSkill&&(n_Delay[4]=eval(document.calcForm.Conf01.value)/100),
  n_Delay[4]>wDelay+wCast&&(wDelay=n_Delay[4]-wCast,w=4),
  0!=n_Delay[5]&&(wDelay=n_Delay[5],w=5),
  n_Delay[6]>wDelay+wCast&&(wDelay=n_Delay[6]-wCast,w=6),
  1==w&&(
    0==n_A_ActiveSkill?
      SkillSearch(187)?(
      ...
      strSUB2name+="Motion Delay (ASPD Based)<BR>",
      strSUB2+=n_Delay[1]+"s<BR>"
    )
  ),
  2==w&&(
    strSUB2name+="Delay (Fixed Skills)<BR>",
    strSUB2+=n_Delay[2]+"s<BR>"
  ),
  3==w&&(
    188==n_A_ActiveSkill||189==n_A_ActiveSkill||289==n_A_ActiveSkill?(
      strSUB2name+="Delay (+delay reception combo)<BR>",
      strSUB2+=n_Delay[3]+"~"+(n_Delay[3]+.3)+"s<BR>"
    ):(
      strSUB2name+="Delay (Forced Motion)<BR>",
      strSUB2+=n_Delay[3]+"s<BR>"
    )
  ),
  4==w&&(
    strSUB2name+="Delay (Input Limit)<BR>",
    strSUB2+=n_Delay[4]+"s<BR>"
  ),
  5==w&&(
    strSUB2name+="Damage Interval<BR>",
    strSUB2+=n_Delay[5]+"s<BR>"
  ),
  6==w&&(
    strSUB2name+="Limited Skill-Duration(?)<BR>",
    strSUB2+=Math.floor(100*wDelay)/100+"s<BR>"
  ),
  myInnerHtml("bSUB2name",strSUB2name,0),
  myInnerHtml("bSUB2",strSUB2,0)
}
function tPlusDamCut(wPDC){
  return 0==Taijin&&1==document.calcForm.A8_Skill14.value&&(
    wPDC=Math.floor(
      10==n_A_WeaponType||17==n_A_WeaponType||18==n_A_WeaponType||19==n_A_WeaponType||20==n_A_WeaponType||21==n_A_WeaponType?.6*wPDC:
      0!=n_A_ActiveSkill?.6*wPDC:
      .8*wPDC
      ),
    document.calcForm.A8_Skill15.value>0&&(wPDC=Math.floor(wPDC*(10/(5*document.calcForm.A8_Skill15.value))))
    ),
    n_Ses&&(
      wPDC=Math.floor(
        10==n_A_WeaponType||17==n_A_WeaponType||18==n_A_WeaponType||19==n_A_WeaponType||20==n_A_WeaponType||21==n_A_WeaponType?.6*wPDC:
    ...
    (n_Enekyori||10==n_A_WeaponType)&&(w=n_B_manual[9],wPDC=Math.floor(wPDC*(100-w)/100)),
    0==eval(document.calcForm.A_youshi.checked)&&(w=n_B_KYOUKA[14],wPDC=Math.floor(wPDC*(100-w)/100)),
    w=n_B_manual[2],
    n_A_Weapon_zokusei==w&&(w=n_B_manual[3],wPDC=Math.floor(wPDC*(100-w)/100)),
    w=n_B_manual[4],
    n_A_Weapon_zokusei==w&&(w=n_B_manual[5],wPDC=Math.floor(wPDC*(100-w)/100)),
    w=n_B_KYOUKA[13],
    0==w||1!=n_Enekyori&&10!=n_A_WeaponType||(w=95-15*n_B_KYOUKA[13],wPDC=Math.floor(wPDC*w/100)),
    w=n_B_KYOUKA[14],
    w>0&&2!=n_Enekyori&&(wPDC-=Math.floor(wPDC*w*6/100)),
    0==wBTw1&&(
      n_B_IJYOU[6]&&0==wLAch&&(wPDC*=2),
      n_B_IJYOU[17]&&3==n_A_Weapon_zokusei&&(wPDC*=2),
      baizok=[110,114,117,119,120],
      0==n_A_Buf6[0]&&n_A_Buf6[1]>=1&&3==n_A_Weapon_zokusei&&(wPDC=Math.floor(wPDC*baizok[n_A_Buf6[1]-1]/100)),
      1==n_A_Buf6[0]&&n_A_Buf6[1]>=1&&1==n_A_Weapon_zokusei&&(wPDC=Math.floor(wPDC*baizok[n_A_Buf6[1]-1]/100)),
      2==n_A_Buf6[0]&&n_A_Buf6[1]>=1&&4==n_A_Weapon_zokusei&&(wPDC=Math.floor(wPDC*baizok[n_A_Buf6[1]-1]/100))
      ),
    n_B_KYOUKA[1]&&0==Taijin&&(wPDC=Math.floor(wPDC/2)),
...
function tPlusTaiseiSyokia(){
  if(Taijin){
    ...
    for(i=0;9>=i;i++)
      document.calcForm.B_ZOKUSEI.options[i]=new Option(ZokuseiOBJ[i]+"1",10*i+1);
    for(i=0;9>=i;i++)
    ...
    document.calcForm.B_LV.value=MonsterOBJ2[i][5],
    document.calcForm.B_VIT.value=MonsterOBJ2[i][7],
    document.calcForm.B_AGI.value=MonsterOBJ2[i][8],
    document.calcForm.B_INT.value=MonsterOBJ2[i][9],
    document.calcForm.B_LUK.value=MonsterOBJ2[i][11],
    document.calcForm.B_DEF.value=MonsterOBJ2[i][14],
    document.calcForm.B_MDEF.value=MonsterOBJ2[i][15]
  }
}
...
WeaponName=[
  ...
  [0, 50, 90, 100, 999],//0-novice
  [0, 1, 51, 101, 70, 71, 72, 74, 75, 78, 83, 84, 85, 86, 87, 90, 91, 999],//1-swordman
  [0, 1, 52, 102, 72, 74, 75, 78, 80, 83, 84, 85, 90, 91, 999],//2-thief
  [0, 1, 53, 103, 71, 73, 74, 77, 78, 85, 89, 57, 999],//3-acolyte
  [0, 1, 54, 104, 75, 76, 83, 89, 999],//4-archer
  [0, 1, 55, 105, 71, 77, 89, 57, 999],//5-magician
  [0, 1, 56, 106, 70, 71, 72, 73, 74, 75, 78, 83, 84, 85, 86, 90, 91, 999],//6-merchant
  [0, 1, 51, 61, 107, 70, 71, 72, 74, 75, 78, 79, 83, 84, 85, 86, 87, 90, 91, 999],//7-knight
  [0, 1, 52, 62, 108, 72, 74, 75, 78, 79, 81, 83, 84, 85, 90, 91, 999],//8-assassin
  [0, 1, 53, 63, 109, 71, 73, 74, 77, 78, 79, 81, 85, 89, 57, 999],//9-priest
  [0, 1, 54, 64, 110, 75, 76, 79, 80, 83, 88, 89, 999],//10-hunter
  [0, 1, 55, 65, 111, 71, 77, 79, 89, 57, 999],//11-wizard
  [0, 1, 56, 66, 112, 70, 71, 72, 73, 74, 75, 78, 79, 83, 84, 85, 86, 90, 91, 999],//12-blacksmith
  [0, 1, 51, 61, 113, 70, 71, 72, 74, 75, 78, 79, 83, 84, 85, 86, 87, 90, 91, 999],//13-crusader
  [0, 1, 52, 62, 114, 72, 74, 75, 76, 78, 79, 80, 83, 84, 85, 88, 91, 999],//14-rogue
  [0, 1, 53, 63, 115, 71, 73, 74, 77, 78, 79, 85, 89, 57, 999],//15-monk
  [0, 1, 54, 64, 116, 74, 75, 76, 79, 83, 89, 999],//16-bard
  [0, 1, 54, 64, 117, 74, 75, 76, 79, 83, 89, 999],//17-dancer
  [0, 1, 55, 65, 118, 71, 77, 79, 89, 57, 999],//18-sage
  [0, 1, 56, 66, 119, 70, 71, 72, 73, 74, 75, 78, 79, 83, 84, 85, 86, 90, 91, 999],//19-alchemist
  [0, 50, 90, 120, 999],//20-super novice
  [0, 1, 51, 61, 107, 121, 70, 71, 72, 74, 75, 78, 79, 82, 83, 84, 85, 86, 87, 90, 91, 999],//21-lord knight
  [0, 1, 52, 62, 108, 122, 72, 74, 75, 78, 79, 81, 82, 83, 84, 85, 90, 91, 999],//22-assassin cross
  [0, 1, 53, 63, 109, 123, 71, 73, 74, 77, 78, 79, 81, 82, 85, 89, 57, 999],//23-high priest
  [0, 1, 54, 64, 110, 124, 75, 76, 79, 80, 82, 83, 88, 89, 999],//24-sniper
  [0, 1, 55, 65, 111, 125, 71, 77, 79, 82, 89, 57, 999],//25-high wizard
  [0, 1, 56, 66, 112, 126, 70, 71, 72, 73, 74, 75, 78, 79, 82, 83, 84, 85, 86, 90, 91, 999],//26-whitesmith
  [0, 1, 51, 61, 113, 127, 70, 71, 72, 74, 75, 78, 79, 82, 83, 84, 85, 86, 87, 90, 91, 999],//27-paladin
  [0, 1, 52, 62, 114, 128, 72, 74, 75, 76, 78, 79, 80, 82, 83, 84, 85, 88, 91, 999],//28-stalker
  [0, 1, 53, 63, 115, 129, 71, 73, 74, 77, 78, 79, 82, 85, 89, 57, 123, 999],//29-champion
  [0, 1, 54, 64, 116, 130, 74, 75, 76, 79, 82, 83, 89, 999],//30-clown
  [0, 1, 54, 64, 117, 131, 74, 75, 76, 79, 82, 83, 89, 999],//31-gypsy
  [0, 1, 55, 65, 118, 132, 71, 77, 79, 82, 89, 57, 999],//32-professor
  [0, 1, 56, 66, 119, 133, 70, 71, 72, 73, 74, 75, 78, 79, 82, 83, 84, 85, 86, 90, 91, 999],//33-creator
  [0],//34-high novice
  [0],//35-high swordman
  [0],//36-high thief
  [0],//37-high acolyte
  ...
  [0],//39-high magician
  [0],//40-high merchant
  [0, 1, 141, 83, 84, 85, 86 /*, 3001, 3051, 3070, 3072*/, 999],//41-taekwon
  [0, 1, 142, 79, 83, 84, 85, 86, 87, 91 /*, 2082, 3001, 3051, 3070, 3072, 3079*/ , 999],//42-star gladiator
  [0, 1, 143, 55, 65, 71, 77, 79, 89, 111 /*, 2082, 3001, 3079, 3089*/ , 999],//43-soul linker
  [0, 1, 144, 58, 52, 91 /*, 3001, 3051, 3054, 3070, 3072, 3089*/ , 999],//44-ninja
  [0, 1, 145, 59, 83 /*, 3001, 3054, 3089*/ , 999]//45-gunslinger
], SyuzokuOBJ=[
  "<b style='color:#9F9E9B'>Formless</b>",
  "<b style='color:#252520'>Undead</b>",
  "<b style='color:brown'>Brute</b>",
  "<b style='color:#88BD68'>Plant</b>",
  "<b style='color:green'>Insect</b>",
  "<b style='color:blue'>Fish</b>",
  "<b style='color:black'>Demon</b>",
  ...
  "<b style='color:#A8A682'>Neutral</b>",
  "<b style='color:blue'>Water</b>",
  "<b style='color:brown'>Earth</b>",
  "<b style='color:red'>Fire</b>",
  "<b style='color:green'>Wind</b>",
  "<b style='color:#7B2488'>Poison</b>",
  "<b style='color:#CDCD40'>Holy</b>",
  "<b style='color:black'>Shadow</b>",
  "<b style='color:#9F9E9B'>Ghost</b>",
  "<b style='color:#252520'>Undead</b>"
], ZokuseiOBJ2=[
  "Neutral ",
  "Water ",
  ...
  "%", "s", "Damage", "Critical Damage", "Critical Rate", "Over 10000 Hits", "Too High to Calculate", "Immesurable", " x ", "Cast Time", "Off", "On"
], Pets=[
...
], bBGC = ["#CDF", "#CCC", "#FDC", "#313", "#000", "#CDF"
], hBGC1 = ["#355", "#57D", "#B44", "#622", "#444", "#0FB91E"
], hBGC2 = ["#477", "#24A", "#A33", "#411", "#222", "#326B2D"
], selBGC = ["#FC8", "#FC8", "#FC8", "#FC8", "#AAA", "#FC8"
], ssBGC = ["#FFF", "#FFF", "#FFF", "#FC8", "#AAA", "#FFF"
], sBGC = ["#466", "#36B", "#A33", "#626", "#000", "#466"
], saBGC = ["#A52", "#811", "#3A3", "#A11", "#A11", "#A52"
], mBGC = ["#FFF", "#FFF", "#FFF", "#C8F", "#444", "#FFF"
], tBGC = ["#FFF", "#FFF", "#FFF", "#C8F", "#555", "#FFF"];
